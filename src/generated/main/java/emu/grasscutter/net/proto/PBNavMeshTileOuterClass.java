...
public final class PBNavMeshTileOuterClass {
  ...
  public interface PBNavMeshTileOrBuilder extends
    ...
    /**
     * <code>repeated .PBNavMeshPoly polys = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int POLYS_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < polys_.size(); i++) {
        output.writeMessage(4, polys_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < polys_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, polys_.get(i));
      }
      for (int i = 0; i < vecs_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ys\030\004 \003(\0132\016.PBNavMeshPoly\022\025\n\004vecs\030\007 \003(\0132\007" +
