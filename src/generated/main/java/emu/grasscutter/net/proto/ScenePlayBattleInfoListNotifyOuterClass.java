...
public final class ScenePlayBattleInfoListNotifyOuterClass {
  ...
  public interface ScenePlayBattleInfoListNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .ScenePlayBattleInfo battle_info_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BATTLE_INFO_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < battleInfoList_.size(); i++) {
        output.writeMessage(4, battleInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < battleInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, battleInfoList_.get(i));
      }
