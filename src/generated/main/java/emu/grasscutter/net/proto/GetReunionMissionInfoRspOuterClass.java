...
public final class GetReunionMissionInfoRspOuterClass {
  ...
  public interface GetReunionMissionInfoRspOrBuilder extends
    ...
    /**
     * <code>.ReunionMissionInfo mission_info = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MISSION_INFO_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (missionInfo_ != null) {
        output.writeMessage(6, getMissionInfo());
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (missionInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, getMissionInfo());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nfoRsp\022)\n\014mission_info\030\006 \001(\0132\023.ReunionMi" +
