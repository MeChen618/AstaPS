...
public final class IrodoriScanEntityRspOuterClass {
  ...
  public interface IrodoriScanEntityRspOrBuilder extends
    ...
    /**
     * <code>.IrodoriPoetryThemeData theme_data = 3;</code>
    ...
    /**
     * <code>bool is_get_inspiration = 10;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int THEME_DATA_FIELD_NUMBER = 3;
    ...
    public static final int IS_GET_INSPIRATION_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (themeData_ != null) {
        output.writeMessage(3, getThemeData());
      }
      if (retcode_ != 0) {
        output.writeInt32(8, retcode_);
      }
      if (isGetInspiration_ != false) {
        output.writeBool(10, isGetInspiration_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (themeData_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getThemeData());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isGetInspiration_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(10, isGetInspiration_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "sp\022+\n\ntheme_data\030\003 \001(\0132\027.IrodoriPoetryTh" +
