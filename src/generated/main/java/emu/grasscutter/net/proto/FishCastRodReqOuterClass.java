...
public final class FishCastRodReqOuterClass {
  ...
  public interface FishCastRodReqOrBuilder extends
    ...
    /**
     * <code>uint32 bait_id = 1;</code>
     * @return The baitId.
     */
    int getBaitId();

    /**
     * <code>uint32 rod_entity_id = 3;</code>
     * @return The rodEntityId.
     */
    int getRodEntityId();

    /**
     * <code>uint32 rod_id = 6;</code>
     * @return The rodId.
     */
    int getRodId();
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BAIT_ID_FIELD_NUMBER = 1;
    private int baitId_;
    /**
     * <code>uint32 bait_id = 1;</code>
     * @return The baitId.
    ...
    public static final int ROD_ENTITY_ID_FIELD_NUMBER = 3;
    ...
    public static final int ROD_ID_FIELD_NUMBER = 6;
    private int rodId_;
    /**
     * <code>uint32 rod_id = 6;</code>
     * @return The rodId.
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (baitId_ != 0) {
        output.writeUInt32(1, baitId_);
      }
      if (rodEntityId_ != 0) {
        output.writeUInt32(3, rodEntityId_);
      }
      if (rodId_ != 0) {
        output.writeUInt32(6, rodId_);
      }
      if (pos_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (baitId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, baitId_);
      }
      if (rodEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, rodEntityId_);
      }
      if (rodId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, rodId_);
      }
      if (pos_ != null) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "bait_id\030\001 \001(\r\022\025\n\rrod_entity_id\030\003 \001(\r\022\016\n\006" +
      "rod_id\030\006 \001(\rB\033\n\031emu.grasscutter.net.prot" +
      "ob\006proto3"
    };
    ...
    internal_static_FishCastRodReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FishCastRodReq_descriptor,
        new java.lang.String[] { "Pos", "BaitId", "RodEntityId", "RodId", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
