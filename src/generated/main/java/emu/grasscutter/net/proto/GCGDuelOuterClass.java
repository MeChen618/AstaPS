...
public final class GCGDuelOuterClass {
  ...
  public interface GCGDuelOrBuilder extends
    ...
    /**
     * <code>map&lt;uint32, .DBFAKFPCGAH&gt; NKCILOPPHGD = 741;</code>
     */
    ...
    /**
     * <code>repeated .GCGDuelChallenge challenge_list = 1377;</code>
     */
    ...
    /**
     * <code>repeated .GCGPlayerField history_field_list = 753;</code>
     */
    java.util.List<emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField> 
        getHistoryFieldListList();
    /**
     * <code>repeated .GCGPlayerField history_field_list = 753;</code>
     */
    emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField getHistoryFieldList(int index);
    /**
     * <code>repeated .GCGPlayerField history_field_list = 753;</code>
     */
    int getHistoryFieldListCount();
    /**
     * <code>repeated .GCGPlayerField history_field_list = 753;</code>
     */
    java.util.List<? extends emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerFieldOrBuilder> 
        getHistoryFieldListOrBuilderList();
    /**
     * <code>repeated .GCGPlayerField history_field_list = 753;</code>
     */
    emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerFieldOrBuilder getHistoryFieldListOrBuilder(
        int index);
    ...
    /**
     * <code>repeated .GCGControllerShowInfo show_info_list = 8;</code>
     */
    ...
    /**
     * <code>repeated .GCGOpTimer op_timer_list = 643;</code>
     */
    ...
    /**
     * <code>repeated .GCGMessagePack history_msg_pack_list = 291;</code>
     */
    ...
    /**
     * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
     */
    java.util.List<emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM> 
        getBCPAFJINAEAList();
    /**
     * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
     */
    emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM getBCPAFJINAEA(int index);
    /**
     * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
     */
    int getBCPAFJINAEACount();
    /**
     * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
     */
    java.util.List<? extends emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFMOrBuilder> 
        getBCPAFJINAEAOrBuilderList();
    /**
     * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
     */
    emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFMOrBuilder getBCPAFJINAEAOrBuilder(
        int index);

    /**
     * <code>repeated uint32 forbid_finish_challenge_list = 699;</code>
    ...
    /**
     * <code>repeated .GCGPVEIntention intetion_list = 4;</code>
     */
    ...
    /**
     * <code>repeated .OHNDPBIBIHJ HFMGPGLDCIJ = 105;</code>
     */
    ...
    /**
     * <code>repeated .GCGCard history_card_list = 408;</code>
     */
    java.util.List<emu.grasscutter.net.proto.GCGCardOuterClass.GCGCard> 
    ...
    /**
     * <code>repeated uint32 card_id_list = 15;</code>
    ...
    /**
     * <code>.GCGGameBusinessType business_type = 12;</code>
    ...
    /**
     * <code>uint32 JMFAKIGLAAI = 10;</code>
     * @return The jMFAKIGLAAI.
     */
    int getJMFAKIGLAAI();

    /**
     * <code>bool BLOEBJLHKJE = 1518;</code>
     * @return The bLOEBJLHKJE.
     */
    boolean getBLOEBJLHKJE();

    /**
     * <code>uint32 DCDDGPKKKIE = 9;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    private GCGDuel() {
      ...
      historyFieldList_ = java.util.Collections.emptyList();
      ...
      bCPAFJINAEA_ = java.util.Collections.emptyList();
    ...
    private GCGDuel(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 5098: {
              if (!((mutable_bitField0_ & 0x00000100) != 0)) {
                bCPAFJINAEA_ = new java.util.ArrayList<emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM>();
                mutable_bitField0_ |= 0x00000100;
              }
              bCPAFJINAEA_.add(
                  input.readMessage(emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.parser(), extensionRegistry));
              break;
            }
            case 5146: {
            ...
            case 6026: {
              if (!((mutable_bitField0_ & 0x00000008) != 0)) {
                historyFieldList_ = new java.util.ArrayList<emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField>();
                mutable_bitField0_ |= 0x00000008;
              }
              historyFieldList_.add(
                  input.readMessage(emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField.parser(), extensionRegistry));
              break;
            }
            case 11018: {
        ...
        if (((mutable_bitField0_ & 0x00000100) != 0)) {
          bCPAFJINAEA_ = java.util.Collections.unmodifiableList(bCPAFJINAEA_);
        }
        if (((mutable_bitField0_ & 0x00000020) != 0)) {
        ...
        if (((mutable_bitField0_ & 0x00000008) != 0)) {
          historyFieldList_ = java.util.Collections.unmodifiableList(historyFieldList_);
        }
        if (((mutable_bitField0_ & 0x00000002) != 0)) {
    ...
    public static final int NKCILOPPHGD_FIELD_NUMBER = 741;
    ...
    public static final int CHALLENGE_LIST_FIELD_NUMBER = 1377;
    ...
    public static final int HISTORY_FIELD_LIST_FIELD_NUMBER = 753;
    private java.util.List<emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField> historyFieldList_;
    /**
     * <code>repeated .GCGPlayerField history_field_list = 753;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField> getHistoryFieldListList() {
      return historyFieldList_;
    }
    /**
     * <code>repeated .GCGPlayerField history_field_list = 753;</code>
     */
     ...
     */
    @java.lang.Override
    public int getHistoryFieldListCount() {
      return historyFieldList_.size();
    }
    /**
     * <code>repeated .GCGPlayerField history_field_list = 753;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField getHistoryFieldList(int index) {
      return historyFieldList_.get(index);
    }
    /**
     * <code>repeated .GCGPlayerField history_field_list = 753;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerFieldOrBuilder getHistoryFieldListOrBuilder(
        int index) {
      return historyFieldList_.get(index);
    }
    ...
    public static final int SHOW_INFO_LIST_FIELD_NUMBER = 8;
    ...
    public static final int OP_TIMER_LIST_FIELD_NUMBER = 643;
    ...
    public static final int HISTORY_MSG_PACK_LIST_FIELD_NUMBER = 291;
    ...
    public static final int BCPAFJINAEA_FIELD_NUMBER = 637;
    private java.util.List<emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM> bCPAFJINAEA_;
    /**
     * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM> getBCPAFJINAEAList() {
      return bCPAFJINAEA_;
    }
    /**
     * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFMOrBuilder> 
        getBCPAFJINAEAOrBuilderList() {
      return bCPAFJINAEA_;
    }
    /**
     ...
     */
    @java.lang.Override
    public int getBCPAFJINAEACount() {
      return bCPAFJINAEA_.size();
    }
    /**
     * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM getBCPAFJINAEA(int index) {
      return bCPAFJINAEA_.get(index);
    }
    /**
     * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFMOrBuilder getBCPAFJINAEAOrBuilder(
        int index) {
      return bCPAFJINAEA_.get(index);
    }

    public static final int FORBID_FINISH_CHALLENGE_LIST_FIELD_NUMBER = 699;
    ...
    public static final int INTETION_LIST_FIELD_NUMBER = 4;
    ...
    public static final int HFMGPGLDCIJ_FIELD_NUMBER = 105;
    ...
    public static final int HISTORY_CARD_LIST_FIELD_NUMBER = 408;
    ...
    public static final int CARD_ID_LIST_FIELD_NUMBER = 15;
    ...
    public static final int JMFAKIGLAAI_FIELD_NUMBER = 10;
    ...
    public static final int BLOEBJLHKJE_FIELD_NUMBER = 1518;
    ...
    public static final int DCDDGPKKKIE_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (costRevise_ != null) {
        output.writeMessage(1, getCostRevise());
      }
      for (int i = 0; i < fieldList_.size(); i++) {
        output.writeMessage(2, fieldList_.get(i));
      }
      if (phase_ != null) {
        output.writeMessage(3, getPhase());
      }
      for (int i = 0; i < intetionList_.size(); i++) {
        output.writeMessage(4, intetionList_.get(i));
      }
      ...
      for (int i = 0; i < showInfoList_.size(); i++) {
        output.writeMessage(8, showInfoList_.get(i));
      }
      if (dCDDGPKKKIE_ != 0) {
        output.writeUInt32(9, dCDDGPKKKIE_);
      }
      if (jMFAKIGLAAI_ != 0) {
        output.writeUInt32(10, jMFAKIGLAAI_);
      }
      if (serverSeq_ != 0) {
      ...
      for (int i = 0; i < hFMGPGLDCIJ_.size(); i++) {
        output.writeMessage(105, hFMGPGLDCIJ_.get(i));
      }
      for (int i = 0; i < historyMsgPackList_.size(); i++) {
        output.writeMessage(291, historyMsgPackList_.get(i));
      }
      for (int i = 0; i < historyCardList_.size(); i++) {
        output.writeMessage(408, historyCardList_.get(i));
      }
      for (int i = 0; i < bCPAFJINAEA_.size(); i++) {
        output.writeMessage(637, bCPAFJINAEA_.get(i));
      }
      for (int i = 0; i < opTimerList_.size(); i++) {
        output.writeMessage(643, opTimerList_.get(i));
      }
      if (getForbidFinishChallengeListList().size() > 0) {
        output.writeUInt32NoTag(5594);
      ...
      com.google.protobuf.GeneratedMessageV3
        .serializeIntegerMapTo(
          ...
          NKCILOPPHGDDefaultEntryHolder.defaultEntry,
          741);
      for (int i = 0; i < historyFieldList_.size(); i++) {
        output.writeMessage(753, historyFieldList_.get(i));
      }
      for (int i = 0; i < challengeList_.size(); i++) {
        output.writeMessage(1377, challengeList_.get(i));
      }
      if (bLOEBJLHKJE_ != false) {
        output.writeBool(1518, bLOEBJLHKJE_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (costRevise_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, getCostRevise());
      }
      for (int i = 0; i < fieldList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (phase_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getPhase());
      }
      for (int i = 0; i < intetionList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, intetionList_.get(i));
      }
      for (int i = 0; i < cardList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      for (int i = 0; i < showInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, showInfoList_.get(i));
      }
      if (dCDDGPKKKIE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, dCDDGPKKKIE_);
      }
      if (jMFAKIGLAAI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, jMFAKIGLAAI_);
      }
      if (serverSeq_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      for (int i = 0; i < hFMGPGLDCIJ_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(105, hFMGPGLDCIJ_.get(i));
      }
      for (int i = 0; i < historyMsgPackList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(291, historyMsgPackList_.get(i));
      }
      for (int i = 0; i < historyCardList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(408, historyCardList_.get(i));
      }
      for (int i = 0; i < bCPAFJINAEA_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(637, bCPAFJINAEA_.get(i));
      }
      for (int i = 0; i < opTimerList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(643, opTimerList_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < forbidFinishChallengeList_.size(); i++) {
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.DBFAKFPCGAHOuterClass.DBFAKFPCGAH> entry
        ...
        nKCILOPPHGD__ = NKCILOPPHGDDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .build();
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(741, nKCILOPPHGD__);
      }
      for (int i = 0; i < historyFieldList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(753, historyFieldList_.get(i));
      }
      for (int i = 0; i < challengeList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1377, challengeList_.get(i));
      }
      if (bLOEBJLHKJE_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1518, bLOEBJLHKJE_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getHistoryFieldListList()
          .equals(other.getHistoryFieldListList())) return false;
      ...
      if (!getBCPAFJINAEAList()
          .equals(other.getBCPAFJINAEAList())) return false;
    ...
    public int hashCode() {
      ...
      if (getHistoryFieldListCount() > 0) {
        hash = (37 * hash) + HISTORY_FIELD_LIST_FIELD_NUMBER;
        hash = (53 * hash) + getHistoryFieldListList().hashCode();
      }
      if (hasCostRevise()) {
      ...
      if (getBCPAFJINAEACount() > 0) {
        hash = (37 * hash) + BCPAFJINAEA_FIELD_NUMBER;
        hash = (53 * hash) + getBCPAFJINAEAList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        if (historyFieldListBuilder_ == null) {
          historyFieldList_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000008);
        } else {
          historyFieldListBuilder_.clear();
        }
        ...
        if (bCPAFJINAEABuilder_ == null) {
          bCPAFJINAEA_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000100);
        } else {
          bCPAFJINAEABuilder_.clear();
        }
        forbidFinishChallengeList_ = emptyIntList();
      ...
      public emu.grasscutter.net.proto.GCGDuelOuterClass.GCGDuel buildPartial() {
        ...
        if (historyFieldListBuilder_ == null) {
          ...
          result.historyFieldList_ = historyFieldList_;
        } else {
          result.historyFieldList_ = historyFieldListBuilder_.build();
        }
        if (costReviseBuilder_ == null) {
        ...
        if (bCPAFJINAEABuilder_ == null) {
          ...
          result.bCPAFJINAEA_ = bCPAFJINAEA_;
        } else {
          result.bCPAFJINAEA_ = bCPAFJINAEABuilder_.build();
        }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GCGDuelOuterClass.GCGDuel other) {
        ...
        if (historyFieldListBuilder_ == null) {
          if (!other.historyFieldList_.isEmpty()) {
            if (historyFieldList_.isEmpty()) {
              historyFieldList_ = other.historyFieldList_;
              bitField0_ = (bitField0_ & ~0x00000008);
            } else {
              ensureHistoryFieldListIsMutable();
              historyFieldList_.addAll(other.historyFieldList_);
            }
            onChanged();
          }
        } else {
          if (!other.historyFieldList_.isEmpty()) {
            if (historyFieldListBuilder_.isEmpty()) {
              historyFieldListBuilder_.dispose();
              historyFieldListBuilder_ = null;
              historyFieldList_ = other.historyFieldList_;
              bitField0_ = (bitField0_ & ~0x00000008);
              historyFieldListBuilder_ = 
                com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                   getHistoryFieldListFieldBuilder() : null;
            } else {
              historyFieldListBuilder_.addAllMessages(other.historyFieldList_);
            }
          }
        }
        ...
        if (bCPAFJINAEABuilder_ == null) {
          if (!other.bCPAFJINAEA_.isEmpty()) {
            if (bCPAFJINAEA_.isEmpty()) {
              bCPAFJINAEA_ = other.bCPAFJINAEA_;
              bitField0_ = (bitField0_ & ~0x00000100);
            } else {
              ensureBCPAFJINAEAIsMutable();
              bCPAFJINAEA_.addAll(other.bCPAFJINAEA_);
            }
            onChanged();
          }
        } else {
          if (!other.bCPAFJINAEA_.isEmpty()) {
            if (bCPAFJINAEABuilder_.isEmpty()) {
              bCPAFJINAEABuilder_.dispose();
              bCPAFJINAEABuilder_ = null;
              bCPAFJINAEA_ = other.bCPAFJINAEA_;
              bitField0_ = (bitField0_ & ~0x00000100);
              bCPAFJINAEABuilder_ = 
                com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                   getBCPAFJINAEAFieldBuilder() : null;
            } else {
              bCPAFJINAEABuilder_.addAllMessages(other.bCPAFJINAEA_);
            }
          }
        }
      ...
      private java.util.List<emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField> historyFieldList_ =
        java.util.Collections.emptyList();
      private void ensureHistoryFieldListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          historyFieldList_ = new java.util.ArrayList<emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField>(historyFieldList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField, emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField.Builder, emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerFieldOrBuilder> historyFieldListBuilder_;
      ...
      public java.util.List<emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField> getHistoryFieldListList() {
        if (historyFieldListBuilder_ == null) {
          return java.util.Collections.unmodifiableList(historyFieldList_);
        } else {
          return historyFieldListBuilder_.getMessageList();
        }
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
      ...
      public int getHistoryFieldListCount() {
        if (historyFieldListBuilder_ == null) {
          ...
          return historyFieldListBuilder_.getCount();
        }
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
      ...
      public emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField getHistoryFieldList(int index) {
        if (historyFieldListBuilder_ == null) {
          ...
          return historyFieldListBuilder_.getMessage(index);
        }
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       */
      public Builder setHistoryFieldList(
          int index, emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField value) {
        if (historyFieldListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          ...
          ensureHistoryFieldListIsMutable();
          historyFieldList_.set(index, value);
          onChanged();
        } else {
          historyFieldListBuilder_.setMessage(index, value);
        }
        return this;
      }
      /**
      ...
      public Builder setHistoryFieldList(
        ...
        if (historyFieldListBuilder_ == null) {
          ensureHistoryFieldListIsMutable();
          historyFieldList_.set(index, builderForValue.build());
          onChanged();
        } else {
          historyFieldListBuilder_.setMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       */
      public Builder addHistoryFieldList(emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField value) {
        if (historyFieldListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureHistoryFieldListIsMutable();
          historyFieldList_.add(value);
          onChanged();
        } else {
          historyFieldListBuilder_.addMessage(value);
        }
        return this;
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       */
      public Builder addHistoryFieldList(
          int index, emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField value) {
        if (historyFieldListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          ...
          ensureHistoryFieldListIsMutable();
          historyFieldList_.add(index, value);
          onChanged();
        } else {
          historyFieldListBuilder_.addMessage(index, value);
        }
        return this;
      }
      /**
      ...
      public Builder addHistoryFieldList(
        ...
        if (historyFieldListBuilder_ == null) {
          ensureHistoryFieldListIsMutable();
          historyFieldList_.add(builderForValue.build());
          onChanged();
        } else {
          historyFieldListBuilder_.addMessage(builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addHistoryFieldList(
        ...
        if (historyFieldListBuilder_ == null) {
          ensureHistoryFieldListIsMutable();
          historyFieldList_.add(index, builderForValue.build());
          onChanged();
        } else {
          historyFieldListBuilder_.addMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       */
      public Builder addAllHistoryFieldList(
          java.lang.Iterable<? extends emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField> values) {
        if (historyFieldListBuilder_ == null) {
          ensureHistoryFieldListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, historyFieldList_);
          onChanged();
        } else {
          historyFieldListBuilder_.addAllMessages(values);
        }
        return this;
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       */
      public Builder clearHistoryFieldList() {
        if (historyFieldListBuilder_ == null) {
          historyFieldList_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000008);
          onChanged();
       ...
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       */
      public Builder removeHistoryFieldList(int index) {
        if (historyFieldListBuilder_ == null) {
          ensureHistoryFieldListIsMutable();
          historyFieldList_.remove(index);
          onChanged();
        } else {
          historyFieldListBuilder_.remove(index);
        }
        return this;
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       */
      public emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField.Builder getHistoryFieldListBuilder(
          int index) {
        return getHistoryFieldListFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       */
      public emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerFieldOrBuilder getHistoryFieldListOrBuilder(
          int index) {
        if (historyFieldListBuilder_ == null) {
          return historyFieldList_.get(index);  } else {
          return historyFieldListBuilder_.getMessageOrBuilder(index);
        }
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
      ...
      public java.util.List<? extends emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerFieldOrBuilder> 
           getHistoryFieldListOrBuilderList() {
        if (historyFieldListBuilder_ != null) {
          return historyFieldListBuilder_.getMessageOrBuilderList();
        } else {
          return java.util.Collections.unmodifiableList(historyFieldList_);
        }
      }
       ...
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       */
      public emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField.Builder addHistoryFieldListBuilder() {
        return getHistoryFieldListFieldBuilder().addBuilder(
            emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGPlayerField history_field_list = 753;</code>
       ...
       */
      public java.util.List<emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField.Builder> 
           getHistoryFieldListBuilderList() {
        return getHistoryFieldListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField, emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField.Builder, emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerFieldOrBuilder> 
          getHistoryFieldListFieldBuilder() {
        if (historyFieldListBuilder_ == null) {
          historyFieldListBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
              emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField, emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerField.Builder, emu.grasscutter.net.proto.GCGPlayerFieldOuterClass.GCGPlayerFieldOrBuilder>(
                  historyFieldList_,
                  ((bitField0_ & 0x00000008) != 0),
                  getParentForChildren(),
                  isClean());
          historyFieldList_ = null;
        }
        return historyFieldListBuilder_;
      }
      ...
      private java.util.List<emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM> bCPAFJINAEA_ =
        java.util.Collections.emptyList();
      private void ensureBCPAFJINAEAIsMutable() {
        if (!((bitField0_ & 0x00000100) != 0)) {
          bCPAFJINAEA_ = new java.util.ArrayList<emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM>(bCPAFJINAEA_);
          bitField0_ |= 0x00000100;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM, emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.Builder, emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFMOrBuilder> bCPAFJINAEABuilder_;
      ...
      public java.util.List<emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM> getBCPAFJINAEAList() {
        if (bCPAFJINAEABuilder_ == null) {
          return java.util.Collections.unmodifiableList(bCPAFJINAEA_);
        } else {
          return bCPAFJINAEABuilder_.getMessageList();
        }
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
      ...
      public int getBCPAFJINAEACount() {
        if (bCPAFJINAEABuilder_ == null) {
          ...
          return bCPAFJINAEABuilder_.getCount();
        }
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
      ...
      public emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM getBCPAFJINAEA(int index) {
        if (bCPAFJINAEABuilder_ == null) {
          ...
          return bCPAFJINAEABuilder_.getMessage(index);
        }
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public Builder setBCPAFJINAEA(
          int index, emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM value) {
        if (bCPAFJINAEABuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureBCPAFJINAEAIsMutable();
          bCPAFJINAEA_.set(index, value);
          onChanged();
        } else {
          bCPAFJINAEABuilder_.setMessage(index, value);
        }
        return this;
      }
      /**
       ...
       */
      public Builder setBCPAFJINAEA(
          int index, emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.Builder builderForValue) {
        if (bCPAFJINAEABuilder_ == null) {
          ensureBCPAFJINAEAIsMutable();
          bCPAFJINAEA_.set(index, builderForValue.build());
          onChanged();
        } else {
          bCPAFJINAEABuilder_.setMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public Builder addBCPAFJINAEA(emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM value) {
        if (bCPAFJINAEABuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureBCPAFJINAEAIsMutable();
          bCPAFJINAEA_.add(value);
          onChanged();
        } else {
          bCPAFJINAEABuilder_.addMessage(value);
        }
        return this;
      }
      /**
      ...
      public Builder addBCPAFJINAEA(
        ...
        if (bCPAFJINAEABuilder_ == null) {
          ...
          ensureBCPAFJINAEAIsMutable();
          bCPAFJINAEA_.add(index, value);
          onChanged();
        } else {
          bCPAFJINAEABuilder_.addMessage(index, value);
        }
        return this;
      }
      /**
       ...
       */
      public Builder addBCPAFJINAEA(
          emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.Builder builderForValue) {
        if (bCPAFJINAEABuilder_ == null) {
          ensureBCPAFJINAEAIsMutable();
          bCPAFJINAEA_.add(builderForValue.build());
          onChanged();
        } else {
          bCPAFJINAEABuilder_.addMessage(builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addBCPAFJINAEA(
        ...
        if (bCPAFJINAEABuilder_ == null) {
          ensureBCPAFJINAEAIsMutable();
          bCPAFJINAEA_.add(index, builderForValue.build());
          onChanged();
        } else {
          bCPAFJINAEABuilder_.addMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public Builder addAllBCPAFJINAEA(
          java.lang.Iterable<? extends emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM> values) {
        if (bCPAFJINAEABuilder_ == null) {
          ensureBCPAFJINAEAIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, bCPAFJINAEA_);
          ...
          bCPAFJINAEABuilder_.addAllMessages(values);
        }
        return this;
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public Builder clearBCPAFJINAEA() {
        if (bCPAFJINAEABuilder_ == null) {
          bCPAFJINAEA_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000100);
          onChanged();
       ...
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public Builder removeBCPAFJINAEA(int index) {
        if (bCPAFJINAEABuilder_ == null) {
          ensureBCPAFJINAEAIsMutable();
          bCPAFJINAEA_.remove(index);
          onChanged();
        } else {
          bCPAFJINAEABuilder_.remove(index);
        }
        return this;
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.Builder getBCPAFJINAEABuilder(
          int index) {
        return getBCPAFJINAEAFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFMOrBuilder getBCPAFJINAEAOrBuilder(
          int index) {
        if (bCPAFJINAEABuilder_ == null) {
          return bCPAFJINAEA_.get(index);  } else {
          return bCPAFJINAEABuilder_.getMessageOrBuilder(index);
        }
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
      ...
      public java.util.List<? extends emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFMOrBuilder> 
           getBCPAFJINAEAOrBuilderList() {
        if (bCPAFJINAEABuilder_ != null) {
          return bCPAFJINAEABuilder_.getMessageOrBuilderList();
        } else {
          return java.util.Collections.unmodifiableList(bCPAFJINAEA_);
        }
      }
       ...
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.Builder addBCPAFJINAEABuilder() {
        return getBCPAFJINAEAFieldBuilder().addBuilder(
            emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.getDefaultInstance());
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.Builder addBCPAFJINAEABuilder(
          int index) {
        return getBCPAFJINAEAFieldBuilder().addBuilder(
            index, emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.getDefaultInstance());
      }
      /**
       * <code>repeated .PKNILIMIHFM BCPAFJINAEA = 637;</code>
       */
      public java.util.List<emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.Builder> 
           getBCPAFJINAEABuilderList() {
        return getBCPAFJINAEAFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM, emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.Builder, emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFMOrBuilder> 
          getBCPAFJINAEAFieldBuilder() {
        if (bCPAFJINAEABuilder_ == null) {
          bCPAFJINAEABuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
              emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM, emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFM.Builder, emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.PKNILIMIHFMOrBuilder>(
                  bCPAFJINAEA_,
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ayerField.proto\032\021OHNDPBIBIHJ.proto\032\021PKNI" +
      "LIMIHFM.proto\"\354\006\n\007GCGDuel\022\030\n\005phase\030\003 \001(\013" +
      "2\t.GCGPhase\022/\n\013NKCILOPPHGD\030\345\005 \003(\0132\031.GCGD" +
      "uel.NKCILOPPHGDEntry\022*\n\016challenge_list\030\341" +
      "\n \003(\0132\021.GCGDuelChallenge\022#\n\nfield_list\030\002" +
      " \003(\0132\017.GCGPlayerField\022,\n\022history_field_l" +
      "ist\030\361\005 \003(\0132\017.GCGPlayerField\022\'\n\013cost_revi" +
      "se\030\001 \001(\0132\022.GCGCostReviseInfo\022.\n\016show_inf" +
      "o_list\030\010 \003(\0132\026.GCGControllerShowInfo\022#\n\r" +
      "op_timer_list\030\203\005 \003(\0132\013.GCGOpTimer\022/\n\025his" +
      "tory_msg_pack_list\030\243\002 \003(\0132\017.GCGMessagePa" +
      "ck\022\033\n\tcard_list\030\005 \003(\0132\010.GCGCard\022\"\n\013BCPAF" +
      "JINAEA\030\375\004 \003(\0132\014.PKNILIMIHFM\022%\n\034forbid_fi" +
      "nish_challenge_list\030\273\005 \003(\r\022\'\n\rintetion_l" +
      "ist\030\004 \003(\0132\020.GCGPVEIntention\022!\n\013HFMGPGLDC" +
      "IJ\030i \003(\0132\014.OHNDPBIBIHJ\022$\n\021history_card_l" +
      "ist\030\230\003 \003(\0132\010.GCGCard\022\024\n\014card_id_list\030\017 \003" +
      "(\r\022\022\n\nserver_seq\030\013 \001(\r\022\017\n\007game_id\030\007 \001(\r\022" +
      "\025\n\rcontroller_id\030\016 \001(\r\022\r\n\005round\030\r \001(\r\022+\n" +
      "\rbusiness_type\030\014 \001(\0162\024.GCGGameBusinessTy" +
      "pe\022\023\n\013JMFAKIGLAAI\030\n \001(\r\022\024\n\013BLOEBJLHKJE\030\356" +
      "\013 \001(\010\022\023\n\013DCDDGPKKKIE\030\t \001(\r\032@\n\020NKCILOPPHG" +
      "DEntry\022\013\n\003key\030\001 \001(\r\022\033\n\005value\030\002 \001(\0132\014.DBF" +
      "AKFPCGAH:\0028\001B\033\n\031emu.grasscutter.net.prot" +
      "ob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.grasscutter.net.proto.PKNILIMIHFMOuterClass.getDescriptor(),
        });
    internal_static_GCGDuel_descriptor =
    ...
    internal_static_GCGDuel_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGDuel_descriptor,
        new java.lang.String[] { "Phase", "NKCILOPPHGD", "ChallengeList", "FieldList", "HistoryFieldList", "CostRevise", "ShowInfoList", "OpTimerList", "HistoryMsgPackList", "CardList", "BCPAFJINAEA", "ForbidFinishChallengeList", "IntetionList", "HFMGPGLDCIJ", "HistoryCardList", "CardIdList", "ServerSeq", "GameId", "ControllerId", "Round", "BusinessType", "JMFAKIGLAAI", "BLOEBJLHKJE", "DCDDGPKKKIE", });
    internal_static_GCGDuel_NKCILOPPHGDEntry_descriptor =
