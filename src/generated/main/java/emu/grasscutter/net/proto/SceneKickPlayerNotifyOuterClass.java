...
public final class SceneKickPlayerNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int KICKER_UID_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (kickerUid_ != 0) {
        output.writeUInt32(5, kickerUid_);
      }
      if (targetUid_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (kickerUid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, kickerUid_);
      }
      if (targetUid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ckPlayerNotify\022\022\n\ntarget_uid\030\016 \001(\r\022\022\n\nki" +
      "cker_uid\030\005 \001(\rB\033\n\031emu.grasscutter.net.pr" +
      "otob\006proto3"
    };
