...
public final class AISnapshotInfoOuterClass {
  ...
  public interface AISnapshotInfoOrBuilder extends
    ...
    /**
     * <code>repeated .AISnapshotEntityData ai_snapshots = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AI_SNAPSHOTS_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < aiSnapshots_.size(); i++) {
        output.writeMessage(3, aiSnapshots_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < aiSnapshots_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, aiSnapshots_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "hots\030\003 \003(\0132\025.AISnapshotEntityDataB\033\n\031emu" +
