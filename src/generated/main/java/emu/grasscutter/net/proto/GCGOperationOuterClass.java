...
public final class GCGOperationOuterClass {
  ...
  public interface GCGOperationOrBuilder extends
    ...
    /**
     * <code>.GCGOperationRedraw op_redraw = 1;</code>
    ...
    /**
     * <code>.GCGOperationReroll op_reroll = 15;</code>
    ...
    /**
     * <code>.GCGOperationAttack op_attack = 13;</code>
    ...
    /**
     * <code>.GCGOperationPass op_pass = 4;</code>
    ...
    /**
     * <code>.GCGOperationPlayCard op_play_card = 5;</code>
    ...
    /**
     * <code>.GCGOperationReboot op_reboot = 9;</code>
    ...
    /**
     * <code>._GCGOperationVehicle op_vehicle = 12;</code>
    ...
    /**
     * <code>._GCGOperationDiscover op_discover = 2;</code>
    ...
    /**
     * <code>._GCGOperationChangeCharacterIndex op_change_character_index = 6;</code>
    ...
    /**
     * <code>._GCGOperationDiscoverRefresh op_discover_refresh = 8;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum OpCase
      ...
      OP_VEHICLE(12),
      OP_DISCOVER(2),
      OP_CHANGE_CHARACTER_INDEX(6),
      OP_DISCOVER_REFRESH(8),
      OP_NOT_SET(0);
      ...
      public static OpCase forNumber(int value) {
        switch (value) {
          case 1: return OP_REDRAW;
          case 3: return OP_SELECT_ON_STAGE;
          case 15: return OP_REROLL;
          case 13: return OP_ATTACK;
          case 4: return OP_PASS;
          case 5: return OP_PLAY_CARD;
          case 9: return OP_REBOOT;
          case 10: return OP_SURRENDER;
          case 12: return OP_VEHICLE;
          case 2: return OP_DISCOVER;
          case 6: return OP_CHANGE_CHARACTER_INDEX;
          case 8: return OP_DISCOVER_REFRESH;
    ...
    public static final int OP_REDRAW_FIELD_NUMBER = 1;
    /**
     * <code>.GCGOperationRedraw op_redraw = 1;</code>
     * @return Whether the opRedraw field is set.
     */
    ...
    public static final int OP_REROLL_FIELD_NUMBER = 15;
    /**
     * <code>.GCGOperationReroll op_reroll = 15;</code>
     * @return Whether the opReroll field is set.
     */
    ...
    public static final int OP_ATTACK_FIELD_NUMBER = 13;
    /**
     * <code>.GCGOperationAttack op_attack = 13;</code>
     * @return Whether the opAttack field is set.
     */
    ...
    public static final int OP_PASS_FIELD_NUMBER = 4;
    /**
     * <code>.GCGOperationPass op_pass = 4;</code>
     * @return Whether the opPass field is set.
     */
    ...
    public static final int OP_PLAY_CARD_FIELD_NUMBER = 5;
    /**
     * <code>.GCGOperationPlayCard op_play_card = 5;</code>
     * @return Whether the opPlayCard field is set.
     */
    ...
    public static final int OP_REBOOT_FIELD_NUMBER = 9;
    /**
     * <code>.GCGOperationReboot op_reboot = 9;</code>
     * @return Whether the opReboot field is set.
     */
    ...
    public static final int OP_VEHICLE_FIELD_NUMBER = 12;
    /**
     * <code>._GCGOperationVehicle op_vehicle = 12;</code>
     * @return Whether the opVehicle field is set.
     */
    ...
    public static final int OP_DISCOVER_FIELD_NUMBER = 2;
    /**
     * <code>._GCGOperationDiscover op_discover = 2;</code>
     * @return Whether the opDiscover field is set.
     */
    ...
    public static final int OP_CHANGE_CHARACTER_INDEX_FIELD_NUMBER = 6;
    /**
     * <code>._GCGOperationChangeCharacterIndex op_change_character_index = 6;</code>
     * @return Whether the opChangeCharacterIndex field is set.
     */
    ...
    public static final int OP_DISCOVER_REFRESH_FIELD_NUMBER = 8;
    /**
     * <code>._GCGOperationDiscoverRefresh op_discover_refresh = 8;</code>
     * @return Whether the opDiscoverRefresh field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (opCase_ == 1) {
        output.writeMessage(1, (emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw) op_);
      }
      if (opCase_ == 2) {
        output.writeMessage(2, (emu.grasscutter.net.proto.GCGOperationDiscover._GCGOperationDiscover) op_);
      }
      if (opCase_ == 3) {
        output.writeMessage(3, (emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect) op_);
      }
      if (opCase_ == 4) {
        output.writeMessage(4, (emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass) op_);
      }
      if (opCase_ == 5) {
        output.writeMessage(5, (emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperationPlayCard) op_);
      }
      if (opCase_ == 6) {
        output.writeMessage(6, (emu.grasscutter.net.proto.GCGOperationChangeCharacterIndex._GCGOperationChangeCharacterIndex) op_);
      }
      if (opCase_ == 8) {
        output.writeMessage(8, (emu.grasscutter.net.proto.GCGOperationDiscoverRefresh._GCGOperationDiscoverRefresh) op_);
      }
      if (opCase_ == 9) {
        output.writeMessage(9, (emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot) op_);
      }
      if (opCase_ == 10) {
        output.writeMessage(10, (emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender) op_);
      }
      if (opCase_ == 12) {
        output.writeMessage(12, (emu.grasscutter.net.proto.GCGOperationVehicle._GCGOperationVehicle) op_);
      }
      if (opCase_ == 13) {
        output.writeMessage(13, (emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack) op_);
      }
      if (opCase_ == 15) {
        output.writeMessage(15, (emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll) op_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (opCase_ == 1) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, (emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw) op_);
      }
      if (opCase_ == 2) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, (emu.grasscutter.net.proto.GCGOperationDiscover._GCGOperationDiscover) op_);
      }
      if (opCase_ == 3) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (opCase_ == 4) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, (emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass) op_);
      }
      if (opCase_ == 5) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, (emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperationPlayCard) op_);
      }
      if (opCase_ == 6) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, (emu.grasscutter.net.proto.GCGOperationChangeCharacterIndex._GCGOperationChangeCharacterIndex) op_);
      }
      if (opCase_ == 8) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, (emu.grasscutter.net.proto.GCGOperationDiscoverRefresh._GCGOperationDiscoverRefresh) op_);
      }
      if (opCase_ == 9) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, (emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot) op_);
      }
      if (opCase_ == 10) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (opCase_ == 12) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, (emu.grasscutter.net.proto.GCGOperationVehicle._GCGOperationVehicle) op_);
      }
      if (opCase_ == 13) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, (emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack) op_);
      }
      if (opCase_ == 15) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(15, (emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll) op_);
      }
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedrawOrBuilder getOpRedrawOrBuilder() {
        if ((opCase_ == 1) && (opRedrawBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationRerollOrBuilder getOpRerollOrBuilder() {
        if ((opCase_ == 15) && (opRerollBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttackOrBuilder getOpAttackOrBuilder() {
        if ((opCase_ == 13) && (opAttackBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPassOrBuilder getOpPassOrBuilder() {
        if ((opCase_ == 4) && (opPassBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperationPlayCardOrBuilder getOpPlayCardOrBuilder() {
        if ((opCase_ == 5) && (opPlayCardBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationRebootOrBuilder getOpRebootOrBuilder() {
        if ((opCase_ == 9) && (opRebootBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationVehicle._GCGOperationVehicleOrBuilder getOpVehicleOrBuilder() {
        if ((opCase_ == 12) && (opVehicleBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationDiscover._GCGOperationDiscoverOrBuilder getOpDiscoverOrBuilder() {
        if ((opCase_ == 2) && (opDiscoverBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationChangeCharacterIndex._GCGOperationChangeCharacterIndexOrBuilder getOpChangeCharacterIndexOrBuilder() {
        if ((opCase_ == 6) && (opChangeCharacterIndexBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationDiscoverRefresh._GCGOperationDiscoverRefreshOrBuilder getOpDiscoverRefreshOrBuilder() {
        if ((opCase_ == 8) && (opDiscoverRefreshBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "aw\030\001 \001(\0132\023.GCGOperationRedrawH\000\0228\n\022op_se" +
      "lect_on_stage\030\003 \001(\0132\032.GCGOperationOnStag" +
      "eSelectH\000\022(\n\top_reroll\030\017 \001(\0132\023.GCGOperat" +
      "ionRerollH\000\022(\n\top_attack\030\r \001(\0132\023.GCGOper" +
      "ationAttackH\000\022$\n\007op_pass\030\004 \001(\0132\021.GCGOper" +
      "ationPassH\000\022-\n\014op_play_card\030\005 \001(\0132\025.GCGO" +
      "perationPlayCardH\000\022(\n\top_reboot\030\t \001(\0132\023." +
      "GCGOperationRebootH\000\022.\n\014op_surrender\030\n \001" +
      "(\0132\026.GCGOperationSurrenderH\000\022+\n\nop_vehic" +
      "le\030\014 \001(\0132\025._GCGOperationVehicleH\000\022-\n\013op_" +
      "discover\030\002 \001(\0132\026._GCGOperationDiscoverH\000" +
      "\022G\n\031op_change_character_index\030\006 \001(\0132\"._G" +
      "CGOperationChangeCharacterIndexH\000\022<\n\023op_" +
      "discover_refresh\030\010 \001(\0132\035._GCGOperationDi" +
      "scoverRefreshH\000B\004\n\002opB\033\n\031emu.grasscutter" +
    ...
    internal_static_GCGOperation_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGOperation_descriptor,
        new java.lang.String[] { "OpRedraw", "OpSelectOnStage", "OpReroll", "OpAttack", "OpPass", "OpPlayCard", "OpReboot", "OpSurrender", "OpVehicle", "OpDiscover", "OpChangeCharacterIndex", "OpDiscoverRefresh", "Op", });
    emu.grasscutter.net.proto.GCGOperationAttackOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationPassOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.getDescriptor();
