...
public final class SaveUgcRspOuterClass {
  ...
  public interface SaveUgcRspOrBuilder extends
    ...
    /**
     * <code>.KLALGJNDAFD HMODKDEMFDE = 12;</code>
    ...
    /**
     * <code>._UgcLanV5CardBriefInfo lan_v_5_card_brief_info = 10;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum BriefCase
      ...
      public static BriefCase forNumber(int value) {
        switch (value) {
          ...
          case 10: return LAN_V_5_CARD_BRIEF_INFO;
    ...
    public static final int HMODKDEMFDE_FIELD_NUMBER = 12;
    ...
    public static final int PEGMIMCENMC_FIELD_NUMBER = 14;
    ...
    public static final int LAN_V_5_CARD_BRIEF_INFO_FIELD_NUMBER = 10;
    /**
     * <code>._UgcLanV5CardBriefInfo lan_v_5_card_brief_info = 10;</code>
     * @return Whether the lanV5CardBriefInfo field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (briefCase_ == 10) {
        output.writeMessage(10, (emu.grasscutter.net.proto.UgcLanV5CardBriefInfo._UgcLanV5CardBriefInfo) brief_);
      }
      if (retcode_ != 0) {
        output.writeInt32(11, retcode_);
      }
      if (hMODKDEMFDE_ != emu.grasscutter.net.proto.KLALGJNDAFDOuterClass.KLALGJNDAFD.KLALGJNDAFD_NONE.getNumber()) {
        output.writeEnum(12, hMODKDEMFDE_);
      }
      if (pEGMIMCENMC_ != false) {
        output.writeBool(14, pEGMIMCENMC_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (briefCase_ == 10) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, (emu.grasscutter.net.proto.UgcLanV5CardBriefInfo._UgcLanV5CardBriefInfo) brief_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (hMODKDEMFDE_ != emu.grasscutter.net.proto.KLALGJNDAFDOuterClass.KLALGJNDAFD.KLALGJNDAFD_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(12, hMODKDEMFDE_);
      }
      if (pEGMIMCENMC_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(14, pEGMIMCENMC_);
      }
      if (ugcType_ != emu.grasscutter.net.proto.UgcTypeOuterClass.UgcType.UgcType_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.UgcLanV5CardBriefInfo._UgcLanV5CardBriefInfoOrBuilder getLanV5CardBriefInfoOrBuilder() {
        if ((briefCase_ == 10) && (lanV5CardBriefInfoBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "sp\022\020\n\010ugc_guid\030\005 \001(\004\022\032\n\010ugc_type\030\017 \001(\0162\010" +
      ".UgcType\022\017\n\007retcode\030\013 \001(\005\022!\n\013HMODKDEMFDE" +
      "\030\014 \001(\0162\014.KLALGJNDAFD\022\023\n\013PEGMIMCENMC\030\016 \001(" +
      "\010\022.\n\020music_brief_info\030\002 \001(\0132\022.UgcMusicBr" +
      "iefInfoH\000\022:\n\027lan_v_5_card_brief_info\030\n \001" +
      "(\0132\027._UgcLanV5CardBriefInfoH\000B\007\n\005briefB\033" +
    ...
    internal_static_SaveUgcRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SaveUgcRsp_descriptor,
        new java.lang.String[] { "UgcGuid", "UgcType", "Retcode", "HMODKDEMFDE", "PEGMIMCENMC", "MusicBriefInfo", "LanV5CardBriefInfo", "Brief", });
    emu.grasscutter.net.proto.KLALGJNDAFDOuterClass.getDescriptor();
    emu.grasscutter.net.proto.UgcMusicBriefInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.UgcTypeOuterClass.getDescriptor();
    emu.grasscutter.net.proto.UgcLanV5CardBriefInfo.getDescriptor();
