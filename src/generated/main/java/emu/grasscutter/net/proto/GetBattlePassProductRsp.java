...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return emu.grasscutter.net.proto.GetBattlePassProductRspOuterClass.internal_static_GetBattlePassProductRsp_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            emu.grasscutter.net.proto.GetBattlePassProductRsp.class, emu.grasscutter.net.proto.GetBattlePassProductRsp.Builder.class);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (battlePassProductPlayType_ != 0) {
      output.writeUInt32(12, battlePassProductPlayType_);
    }
    if (curScheduleId_ != 0) {
  ...
  public int getSerializedSize() {
    ...
    if (battlePassProductPlayType_ != 0) {
      size += com.google.protobuf.CodedOutputStream
        .computeUInt32Size(12, battlePassProductPlayType_);
    }
    if (curScheduleId_ != 0) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof emu.grasscutter.net.proto.GetBattlePassProductRsp)) {
      return super.equals(obj);
    }
    emu.grasscutter.net.proto.GetBattlePassProductRsp other = (emu.grasscutter.net.proto.GetBattlePassProductRsp) obj;
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.GetBattlePassProductRsp getDefaultInstanceForType() {
      return emu.grasscutter.net.proto.GetBattlePassProductRsp.getDefaultInstance();
    }

    @java.lang.Override
    public emu.grasscutter.net.proto.GetBattlePassProductRsp build() {
      emu.grasscutter.net.proto.GetBattlePassProductRsp result = buildPartial();
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.GetBattlePassProductRsp buildPartial() {
      emu.grasscutter.net.proto.GetBattlePassProductRsp result = new emu.grasscutter.net.proto.GetBattlePassProductRsp(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof emu.grasscutter.net.proto.GetBattlePassProductRsp) {
        return mergeFrom((emu.grasscutter.net.proto.GetBattlePassProductRsp)other);
      } else {
    ...
    public Builder mergeFrom(emu.grasscutter.net.proto.GetBattlePassProductRsp other) {
      if (other == emu.grasscutter.net.proto.GetBattlePassProductRsp.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      emu.grasscutter.net.proto.GetBattlePassProductRsp parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (emu.grasscutter.net.proto.GetBattlePassProductRsp) e.getUnfinishedMessage();
  ...
  static {
    DEFAULT_INSTANCE = new emu.grasscutter.net.proto.GetBattlePassProductRsp();
  }
