...
public final class GCGGameBriefDataNotifyOuterClass {
  ...
  public interface GCGGameBriefDataNotifyOrBuilder extends
    ...
    /**
     * <code>.GCGGameBriefData gcg_brief_data = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int GCG_BRIEF_DATA_FIELD_NUMBER = 5;
    ...
    public static final int IS_NEW_GAME_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (gcgBriefData_ != null) {
        output.writeMessage(5, getGcgBriefData());
      }
      if (isNewGame_ != false) {
        output.writeBool(9, isNewGame_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (gcgBriefData_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, getGcgBriefData());
      }
      if (isNewGame_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(9, isNewGame_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022)\n\016gcg_brief_data\030\005 \001(\0132\021.GCGGameBriefD" +
      "ata\022\023\n\013is_new_game\030\t \001(\010B\033\n\031emu.grasscut" +
