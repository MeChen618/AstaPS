...
public final class GCGLevelChallengeNotifyOuterClass {
  ...
  public interface GCGLevelChallengeNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .GCGLevelData level_list = 9;</code>
     */
    ...
    /**
     * <code>repeated uint32 unlock_world_challenge_list = 15;</code>
    ...
    /**
     * <code>repeated .GCGBossChallengeData unlock_boss_challenge_list = 14;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int UNLOCK_WORLD_CHALLENGE_LIST_FIELD_NUMBER = 15;
    ...
    public static final int UNLOCK_BOSS_CHALLENGE_LIST_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < unlockBossChallengeList_.size(); i++) {
        output.writeMessage(14, unlockBossChallengeList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < unlockBossChallengeList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, unlockBossChallengeList_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < unlockWorldChallengeList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t\030\t \003(\0132\r.GCGLevelData\022#\n\033unlock_world_c" +
      "hallenge_list\030\017 \003(\r\0229\n\032unlock_boss_chall" +
      "enge_list\030\016 \003(\0132\025.GCGBossChallengeDataB\033" +
