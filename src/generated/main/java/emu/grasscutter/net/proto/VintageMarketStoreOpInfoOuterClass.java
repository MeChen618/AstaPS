...
public final class VintageMarketStoreOpInfoOuterClass {
  ...
  public interface VintageMarketStoreOpInfoOrBuilder extends
    ...
    /**
     * <code>repeated uint32 add_attr_list = 10;</code>
    ...
    /**
     * <code>uint32 help_skill_id = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ADD_ATTR_LIST_FIELD_NUMBER = 10;
    ...
    public static final int HELP_UID_FIELD_NUMBER = 5;
    ...
    public static final int HELP_SKILL_ID_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (helpUid_ != 0) {
        output.writeUInt32(5, helpUid_);
      }
      if (helpSkillId_ != 0) {
        output.writeUInt32(6, helpSkillId_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (helpUid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, helpUid_);
      }
      if (helpSkillId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, helpSkillId_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < strategyList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tageMarketStoreOpInfo\022\025\n\rstrategy_list\030\007" +
      " \003(\r\022\025\n\radd_attr_list\030\n \003(\r\022\020\n\010help_uid\030" +
      "\005 \001(\r\022\020\n\010store_id\030\t \001(\r\022\025\n\rhelp_skill_id" +
    ...
    internal_static_VintageMarketStoreOpInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_VintageMarketStoreOpInfo_descriptor,
        new java.lang.String[] { "StrategyList", "AddAttrList", "HelpUid", "StoreId", "HelpSkillId", });
  }
