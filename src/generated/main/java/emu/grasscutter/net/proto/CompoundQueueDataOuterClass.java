...
public final class CompoundQueueDataOuterClass {
  ...
  public interface CompoundQueueDataOrBuilder extends
    ...
    /**
     * <code>uint32 output_time = 7;</code>
    ...
    /**
     * <code>uint32 wait_count = 1;</code>
     * @return The waitCount.
     */
    int getWaitCount();

    /**
     * <code>uint32 output_count = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int OUTPUT_TIME_FIELD_NUMBER = 7;
    ...
    public static final int OUTPUT_COUNT_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (waitCount_ != 0) {
        output.writeUInt32(1, waitCount_);
      }
      if (outputCount_ != 0) {
        output.writeUInt32(2, outputCount_);
      }
      if (outputTime_ != 0) {
        output.writeUInt32(7, outputTime_);
      }
      if (compoundId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (waitCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, waitCount_);
      }
      if (outputCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (outputTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, outputTime_);
      }
      if (compoundId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ueData\022\023\n\013output_time\030\007 \001(\r\022\023\n\013compound_" +
      "id\030\n \001(\r\022\022\n\nwait_count\030\001 \001(\r\022\024\n\014output_c" +
    ...
    internal_static_CompoundQueueData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_CompoundQueueData_descriptor,
        new java.lang.String[] { "OutputTime", "CompoundId", "WaitCount", "OutputCount", });
  }
