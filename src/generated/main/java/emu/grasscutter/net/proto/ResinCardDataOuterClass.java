...
public final class ResinCardDataOuterClass {
  ...
  public interface ResinCardDataOrBuilder extends
    ...
    /**
     * <code>uint32 remain_reward_days = 1;</code>
     * @return The remainRewardDays.
     */
    int getRemainRewardDays();

    /**
     * <code>uint32 last_daily_reward_time = 8;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int REMAIN_REWARD_DAYS_FIELD_NUMBER = 1;
    ...
    public static final int LAST_DAILY_REWARD_TIME_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (remainRewardDays_ != 0) {
        output.writeUInt32(1, remainRewardDays_);
      }
      if (expireTime_ != 0) {
        output.writeUInt32(4, expireTime_);
      }
      if (lastDailyRewardTime_ != 0) {
        output.writeUInt32(8, lastDailyRewardTime_);
      }
      if (configId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (remainRewardDays_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, remainRewardDays_);
      }
      if (expireTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (lastDailyRewardTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, lastDailyRewardTime_);
      }
      if (configId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "s\030\001 \001(\r\022\036\n\026last_daily_reward_time\030\010 \001(\r\022" +
    ...
    internal_static_ResinCardData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ResinCardData_descriptor,
        new java.lang.String[] { "ExpireTime", "RemainRewardDays", "LastDailyRewardTime", "ConfigId", });
  }
