...
public final class GCGWorldPlayerGCGStateRspOuterClass {
  ...
  public interface GCGWorldPlayerGCGStateRspOrBuilder extends
    ...
    /**
     * <code>repeated .GCGPlayerGCGState player_state = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < playerState_.size(); i++) {
        output.writeMessage(6, playerState_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < playerState_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, playerState_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tateRsp\022(\n\014player_state\030\006 \003(\0132\022.GCGPlaye" +
