...
public final class SignInInfoRspOuterClass {
  ...
  public interface SignInInfoRspOrBuilder extends
    ...
    /**
     * <code>repeated .SignInInfo sign_in_info_list = 12;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SIGN_IN_INFO_LIST_FIELD_NUMBER = 12;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < signInInfoList_.size(); i++) {
        output.writeMessage(12, signInInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < signInInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, signInInfoList_.get(i));
      }
