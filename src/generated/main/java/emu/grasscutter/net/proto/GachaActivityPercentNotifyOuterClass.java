...
public final class GachaActivityPercentNotifyOuterClass {
  ...
  public interface GachaActivityPercentNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 ELLKFECGMJH = 3;</code>
     * @return The eLLKFECGMJH.
     */
    int getELLKFECGMJH();

    /**
     * <code>uint32 KCFGFKDCLLI = 2;</code>
     * @return The kCFGFKDCLLI.
     */
    int getKCFGFKDCLLI();

    /**
     * <code>uint32 BOIMBGOJIBG = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ELLKFECGMJH_FIELD_NUMBER = 3;
    ...
    public static final int KCFGFKDCLLI_FIELD_NUMBER = 2;
    ...
    public static final int BOIMBGOJIBG_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (kCFGFKDCLLI_ != 0) {
        output.writeUInt32(2, kCFGFKDCLLI_);
      }
      if (eLLKFECGMJH_ != 0) {
        output.writeUInt32(3, eLLKFECGMJH_);
      }
      if (bOIMBGOJIBG_ != 0) {
        output.writeUInt32(4, bOIMBGOJIBG_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (kCFGFKDCLLI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, kCFGFKDCLLI_);
      }
      if (eLLKFECGMJH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, eLLKFECGMJH_);
      }
      if (bOIMBGOJIBG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, bOIMBGOJIBG_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "map\030\017 \003(\0132-.GachaActivityPercentNotify.T" +
      "argetNumMapEntry\022\023\n\013ELLKFECGMJH\030\003 \001(\r\022\023\n" +
      "\013KCFGFKDCLLI\030\002 \001(\r\022\023\n\013BOIMBGOJIBG\030\004 \001(\r\032" +
