...
public final class HomeSearchBlueprintRspOuterClass {
  ...
  public interface HomeSearchBlueprintRspOrBuilder extends
    ...
    /**
     * <code>.HomeBlueprintSearchInfo search_info = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SEARCH_INFO_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (searchInfo_ != null) {
        output.writeMessage(5, getSearchInfo());
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (searchInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, getSearchInfo());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rintRsp\022-\n\013search_info\030\005 \001(\0132\030.HomeBluep" +
