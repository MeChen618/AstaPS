...
public final class BatchBuyGoodsRspOuterClass {
  ...
  public interface BatchBuyGoodsRspOrBuilder extends
    ...
    /**
     * <code>uint32 FGGCODPFKAH = 8;</code>
     * @return The fGGCODPFKAH.
     */
    int getFGGCODPFKAH();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int FGGCODPFKAH_FIELD_NUMBER = 8;
    private int fGGCODPFKAH_;
    /**
     * <code>uint32 FGGCODPFKAH = 8;</code>
     * @return The fGGCODPFKAH.
     */
    @java.lang.Override
    public int getFGGCODPFKAH() {
      return fGGCODPFKAH_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (fGGCODPFKAH_ != 0) {
        output.writeUInt32(8, fGGCODPFKAH_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (fGGCODPFKAH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, fGGCODPFKAH_);
      }
      for (int i = 0; i < goodsList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getFGGCODPFKAH()
          != other.getFGGCODPFKAH()) return false;
      if (getRetcode()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + FGGCODPFKAH_FIELD_NUMBER;
      hash = (53 * hash) + getFGGCODPFKAH();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp buildPartial() {
        ...
        result.fGGCODPFKAH_ = fGGCODPFKAH_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BatchBuyGoodsRspOuterClass.BatchBuyGoodsRsp other) {
        ...
        if (other.getFGGCODPFKAH() != 0) {
          setFGGCODPFKAH(other.getFGGCODPFKAH());
        }
      ...
      /**
       * <code>uint32 FGGCODPFKAH = 8;</code>
       * @param value The fGGCODPFKAH to set.
       * @return This builder for chaining.
       */
      public Builder setFGGCODPFKAH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearFGGCODPFKAH() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "proto\032\017ShopGoods.proto\"\223\001\n\020BatchBuyGoods" +
      "Rsp\022&\n\016buy_goods_list\030\004 \003(\0132\016.BuyGoodsPa" +
      "ram\022\036\n\ngoods_list\030\t \003(\0132\n.ShopGoods\022\021\n\ts" +
      "hop_type\030\006 \001(\r\022\023\n\013FGGCODPFKAH\030\010 \001(\r\022\017\n\007r" +
    ...
    internal_static_BatchBuyGoodsRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BatchBuyGoodsRsp_descriptor,
        new java.lang.String[] { "BuyGoodsList", "GoodsList", "ShopType", "FGGCODPFKAH", "Retcode", });
    emu.grasscutter.net.proto.BuyGoodsParamOuterClass.getDescriptor();
    emu.grasscutter.net.proto.ShopGoodsOuterClass.getDescriptor();
  }
