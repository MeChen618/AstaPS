...
public final class WindSeedClientNotifyOuterClass {
  ...
  public interface WindSeedClientNotifyOrBuilder extends
    ...
    /**
     * <code>.WindSeedClientNotify.AddWindBulletNotify add_wind_bullet_notify = 14;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface AddWindBulletNotifyOrBuilder extends
      ...
      /**
       * <code>uint32 ELLDNEPCBJD = 9;</code>
       * @return The eLLDNEPCBJD.
       */
      int getELLDNEPCBJD();

      /**
       * <code>uint32 EKOFDOADGJM = 10;</code>
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final int SEED_POS_FIELD_NUMBER = 1;
      ...
      public static final int ELLDNEPCBJD_FIELD_NUMBER = 9;
      ...
      public static final int EKOFDOADGJM_FIELD_NUMBER = 10;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
                          throws java.io.IOException {
        if (seedPos_ != null) {
          output.writeMessage(1, getSeedPos());
        }
        if (eLLDNEPCBJD_ != 0) {
          output.writeUInt32(9, eLLDNEPCBJD_);
        }
        if (eKOFDOADGJM_ != 0) {
          output.writeUInt32(10, eKOFDOADGJM_);
        }
        unknownFields.writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        if (seedPos_ != null) {
          size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(1, getSeedPos());
        }
        if (eLLDNEPCBJD_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(9, eLLDNEPCBJD_);
        }
        if (eKOFDOADGJM_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(10, eKOFDOADGJM_);
        }
        size += unknownFields.getSerializedSize();
        memoizedSize = size;
        return size;
    ...
    private static final long serialVersionUID = 0L;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (!areaCode_.isEmpty()) {
          output.writeBytes(11, areaCode_);
        }
        unknownFields.writeTo(output);
      }
    ...
    public enum NotifyCase
      ...
      public static NotifyCase forNumber(int value) {
        switch (value) {
          ...
          case 14: return ADD_WIND_BULLET_NOTIFY;
    ...
    public static final int ADD_WIND_BULLET_NOTIFY_FIELD_NUMBER = 14;
    /**
     * <code>.WindSeedClientNotify.AddWindBulletNotify add_wind_bullet_notify = 14;</code>
     * @return Whether the addWindBulletNotify field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (notifyCase_ == 14) {
        output.writeMessage(14, (emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.AddWindBulletNotify) notify_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (notifyCase_ == 14) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, (emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.AddWindBulletNotify) notify_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.AddWindBulletNotifyOrBuilder getAddWindBulletNotifyOrBuilder() {
        if ((notifyCase_ == 14) && (addWindBulletNotifyBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fyH\000\022=\n\016refresh_notify\030\014 \001(\0132#.WindSeedC" +
      "lientNotify.RefreshNotifyH\000\022K\n\026add_wind_" +
      "bullet_notify\030\016 \001(\0132).WindSeedClientNoti" +
      "fy.AddWindBulletNotifyH\000\032$\n\rRefreshNotif" +
      "y\022\023\n\013refresh_num\030\n \001(\r\032Z\n\023AddWindBulletN" +
      "otify\022\031\n\010seed_pos\030\001 \001(\0132\007.Vector\022\023\n\013ELLD" +
      "NEPCBJD\030\t \001(\r\022\023\n\013EKOFDOADGJM\030\n \001(\r\032C\n\nAr" +
      "eaNotify\022\021\n\tarea_code\030\013 \001(\014\022\017\n\007area_id\030\005" +
    ...
    internal_static_WindSeedClientNotify_AddWindBulletNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_WindSeedClientNotify_AddWindBulletNotify_descriptor,
        new java.lang.String[] { "SeedPos", "ELLDNEPCBJD", "EKOFDOADGJM", });
    internal_static_WindSeedClientNotify_AreaNotify_descriptor =
