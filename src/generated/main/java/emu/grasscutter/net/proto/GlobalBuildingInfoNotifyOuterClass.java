...
public final class GlobalBuildingInfoNotifyOuterClass {
  ...
  public interface GlobalBuildingInfoNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .BuildingInfo building_list = 14;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BUILDING_LIST_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (maxNum_ != 0) {
        output.writeUInt32(10, maxNum_);
      }
      for (int i = 0; i < buildingList_.size(); i++) {
        output.writeMessage(14, buildingList_.get(i));
      }
      if (currentNum_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (maxNum_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, maxNum_);
      }
      for (int i = 0; i < buildingList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, buildingList_.get(i));
      }
      if (currentNum_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022$\n\rbuilding_list\030\016 \003(\0132\r.BuildingInfo\022\017" +
    ...
    internal_static_GlobalBuildingInfoNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GlobalBuildingInfoNotify_descriptor,
        new java.lang.String[] { "BuildingList", "MaxNum", "CurrentNum", });
    emu.grasscutter.net.proto.BuildingInfoOuterClass.getDescriptor();
  }
