...
public final class GCGMessagePackNotifyOuterClass {
  ...
  public interface GCGMessagePackNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .GCGMessagePack msg_pack_list = 8;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MSG_PACK_LIST_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < msgPackList_.size(); i++) {
        output.writeMessage(8, msgPackList_.get(i));
      }
      if (serverSeq_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < msgPackList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, msgPackList_.get(i));
      }
      if (serverSeq_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "g_pack_list\030\010 \003(\0132\017.GCGMessagePack\022\022\n\nse" +
