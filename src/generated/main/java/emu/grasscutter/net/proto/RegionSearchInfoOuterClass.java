...
public final class RegionSearchInfoOuterClass {
  ...
  public interface RegionSearchInfoOrBuilder extends
    ...
    /**
     * <code>repeated .RegionSearch region_search_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int REGION_SEARCH_LIST_FIELD_NUMBER = 2;
    ...
    public static final int IS_ENTERED_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < regionSearchList_.size(); i++) {
        output.writeMessage(2, regionSearchList_.get(i));
      }
      if (isEntered_ != false) {
        output.writeBool(3, isEntered_);
      }
      if (id_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < regionSearchList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, regionSearchList_.get(i));
      }
      if (isEntered_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(3, isEntered_);
      }
      if (id_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "h_list\030\002 \003(\0132\r.RegionSearch\022\n\n\002id\030\n \001(\r\022" +
      "\022\n\nis_entered\030\003 \001(\010B\033\n\031emu.grasscutter.n" +
      "et.protob\006proto3"
    };
