...
public final class FinishMainCoopReqOuterClass {
  ...
  public interface FinishMainCoopReqOrBuilder extends
    ...
    /**
     * <code>uint32 ending_save_point_id = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ENDING_SAVE_POINT_ID_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (endingSavePointId_ != 0) {
        output.writeUInt32(2, endingSavePointId_);
      }
      if (id_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (endingSavePointId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, endingSavePointId_);
      }
      if (id_ != 0) {
        size += com.google.protobuf.CodedOutputStream
