...
public final class CrystalLinkEnterDungeonReqOuterClass {
  ...
  public interface CrystalLinkEnterDungeonReqOrBuilder extends
    ...
    /**
     * <code>repeated .CrystalLinkTeamInfo team_info_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < teamInfoList_.size(); i++) {
        output.writeMessage(4, teamInfoList_.get(i));
      }
      if (difficultyId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < teamInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, teamInfoList_.get(i));
      }
      if (difficultyId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rDungeonReq\022,\n\016team_info_list\030\004 \003(\0132\024.Cr" +
      "ystalLinkTeamInfo\022\025\n\rdifficulty_id\030\006 \001(\r" +
