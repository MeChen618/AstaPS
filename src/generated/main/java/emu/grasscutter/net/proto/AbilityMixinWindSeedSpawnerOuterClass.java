...
public final class AbilityMixinWindSeedSpawnerOuterClass {
  ...
  public interface AbilityMixinWindSeedSpawnerOrBuilder extends
    ...
    /**
     * <code>.AbilityMixinWindSeedSpawner.AddSignal add_signal = 12;</code>
    ...
    /**
     * <code>.AbilityMixinWindSeedSpawner.CatchSeed catch_seed = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum CmdCase
      ...
      public static CmdCase forNumber(int value) {
        switch (value) {
          case 12: return ADD_SIGNAL;
          case 1: return REFRESH_SEED;
          case 7: return CATCH_SEED;
    ...
    public static final int ADD_SIGNAL_FIELD_NUMBER = 12;
    /**
     * <code>.AbilityMixinWindSeedSpawner.AddSignal add_signal = 12;</code>
     * @return Whether the addSignal field is set.
     */
    ...
    public static final int CATCH_SEED_FIELD_NUMBER = 7;
    /**
     * <code>.AbilityMixinWindSeedSpawner.CatchSeed catch_seed = 7;</code>
     * @return Whether the catchSeed field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (cmdCase_ == 7) {
        output.writeMessage(7, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeed) cmd_);
      }
      if (cmdCase_ == 12) {
        output.writeMessage(12, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.AddSignal) cmd_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (cmdCase_ == 7) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeed) cmd_);
      }
      if (cmdCase_ == 12) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.AddSignal) cmd_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.AddSignalOrBuilder getAddSignalOrBuilder() {
        if ((cmdCase_ == 12) && (addSignalBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeedOrBuilder getCatchSeedOrBuilder() {
        if ((cmdCase_ == 7) && (catchSeedBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "r\022<\n\nadd_signal\030\014 \001(\0132&.AbilityMixinWind" +
      "SeedSpawner.AddSignalH\000\022@\n\014refresh_seed\030" +
      "\001 \001(\0132(.AbilityMixinWindSeedSpawner.Refr" +
      "eshSeedH\000\022<\n\ncatch_seed\030\007 \001(\0132&.AbilityM" +
