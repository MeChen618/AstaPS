...
public final class GeneralMatchInfoOuterClass {
  ...
  public interface GeneralMatchInfoOrBuilder extends
    ...
    /**
     * <code>repeated .MatchPlayerInfo player_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < playerList_.size(); i++) {
        output.writeMessage(4, playerList_.get(i));
      }
      if (matchParam_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < playerList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, playerList_.get(i));
      }
      if (matchParam_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "st\030\004 \003(\0132\020.MatchPlayerInfo\022\023\n\013match_para" +
      "m\030\005 \001(\r\022\020\n\010match_id\030\r \001(\rB\033\n\031emu.grasscu" +
