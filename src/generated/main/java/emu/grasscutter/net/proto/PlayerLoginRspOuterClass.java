...
public final class PlayerLoginRspOuterClass {
  ...
  public interface PlayerLoginRspOrBuilder extends
    ...
    /**
     * <code>.StopServerInfo stop_server_info = 318;</code>
     * @return Whether the stopServerInfo field is set.
     */
    boolean hasStopServerInfo();
    /**
     * <code>.StopServerInfo stop_server_info = 318;</code>
     * @return The stopServerInfo.
     */
    emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo getStopServerInfo();
    /**
     * <code>.StopServerInfo stop_server_info = 318;</code>
     */
    emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfoOrBuilder getStopServerInfoOrBuilder();
    ...
    /**
     * <code>string client_silence_md5 = 1435;</code>
    ...
    /**
     * <code>string client_md5 = 1656;</code>
    ...
    /**
     * <code>string client_version_suffix = 1192;</code>
    ...
    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 1390;</code>
     */
    ...
    /**
     * <code>string client_silence_version_suffix = 1477;</code>
    ...
    /**
     * <code>uint32 DPPKDPCKANP = 600;</code>
     * @return The dPPKDPCKANP.
     */
    int getDPPKDPCKANP();
    ...
    /**
     * <code>bool is_sc_open = 1869;</code>
     * @return The isScOpen.
     */
    boolean getIsScOpen();
    ...
    /**
     * <code>bool is_use_ability_hash = 1856;</code>
     * @return The isUseAbilityHash.
     */
    boolean getIsUseAbilityHash();

    /**
     * <code>bool GICKBBGJGCK = 2;</code>
     * @return The gICKBBGJGCK.
     */
    boolean getGICKBBGJGCK();

    /**
     * <code>uint32 JBEGCLMHOPF = 1;</code>
     * @return The jBEGCLMHOPF.
     */
    int getJBEGCLMHOPF();
    ...
    /**
     * <code>uint32 HPHGKOCDPJE = 1123;</code>
    ...
    /**
     * <code>bool KLKDKMBAPGA = 1994;</code>
    ...
    /**
     * <code>bool OEMHPIKBDMB = 1056;</code>
     * @return The oEMHPIKBDMB.
     */
    boolean getOEMHPIKBDMB();

    /**
     * <code>uint32 HACEPFEEKGA = 458;</code>
     * @return The hACEPFEEKGA.
     */
    int getHACEPFEEKGA();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 2546: {
              ...
              if (stopServerInfo_ != null) {
                subBuilder = stopServerInfo_.toBuilder();
              }
              stopServerInfo_ = input.readMessage(emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(stopServerInfo_);
                stopServerInfo_ = subBuilder.buildPartial();
              }
    ...
    public static final int STOP_SERVER_INFO_FIELD_NUMBER = 318;
    private emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo stopServerInfo_;
    /**
     * <code>.StopServerInfo stop_server_info = 318;</code>
     * @return Whether the stopServerInfo field is set.
     */
    @java.lang.Override
    public boolean hasStopServerInfo() {
      return stopServerInfo_ != null;
    }
    /**
     * <code>.StopServerInfo stop_server_info = 318;</code>
     * @return The stopServerInfo.
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo getStopServerInfo() {
      return stopServerInfo_ == null ? emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo.getDefaultInstance() : stopServerInfo_;
    }
    /**
     * <code>.StopServerInfo stop_server_info = 318;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfoOrBuilder getStopServerInfoOrBuilder() {
      return getStopServerInfo();
    }
    ...
    public static final int CLIENT_SILENCE_MD5_FIELD_NUMBER = 1435;
    ...
    public static final int CLIENT_MD5_FIELD_NUMBER = 1656;
    ...
    public static final int CLIENT_VERSION_SUFFIX_FIELD_NUMBER = 1192;
    ...
    public static final int FEATURE_BLOCK_INFO_LIST_FIELD_NUMBER = 1390;
    ...
    public static final int CLIENT_SILENCE_VERSION_SUFFIX_FIELD_NUMBER = 1477;
    ...
    public static final int DPPKDPCKANP_FIELD_NUMBER = 600;
    private int dPPKDPCKANP_;
    /**
     * <code>uint32 DPPKDPCKANP = 600;</code>
     * @return The dPPKDPCKANP.
     */
    @java.lang.Override
    public int getDPPKDPCKANP() {
      return dPPKDPCKANP_;
    }
    ...
    public static final int IS_SC_OPEN_FIELD_NUMBER = 1869;
    ...
    public static final int IS_USE_ABILITY_HASH_FIELD_NUMBER = 1856;
    ...
    public static final int GICKBBGJGCK_FIELD_NUMBER = 2;
    ...
    public static final int JBEGCLMHOPF_FIELD_NUMBER = 1;
    private int jBEGCLMHOPF_;
    /**
     * <code>uint32 JBEGCLMHOPF = 1;</code>
     * @return The jBEGCLMHOPF.
     */
    @java.lang.Override
    public int getJBEGCLMHOPF() {
      return jBEGCLMHOPF_;
    }
    ...
    public static final int HPHGKOCDPJE_FIELD_NUMBER = 1123;
    ...
    public static final int KLKDKMBAPGA_FIELD_NUMBER = 1994;
    ...
    public static final int GHAJDNKLEDA_FIELD_NUMBER = 12;
    ...
    public static final int OEMHPIKBDMB_FIELD_NUMBER = 1056;
    ...
    public static final int HACEPFEEKGA_FIELD_NUMBER = 458;
    private int hACEPFEEKGA_;
    /**
     * <code>uint32 HACEPFEEKGA = 458;</code>
     * @return The hACEPFEEKGA.
     */
    @java.lang.Override
    public int getHACEPFEEKGA() {
      return hACEPFEEKGA_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (jBEGCLMHOPF_ != 0) {
        output.writeUInt32(1, jBEGCLMHOPF_);
      }
      if (gICKBBGJGCK_ != false) {
        output.writeBool(2, gICKBBGJGCK_);
      }
      ...
      if (gHAJDNKLEDA_ != false) {
        output.writeBool(12, gHAJDNKLEDA_);
      }
      ...
      if (stopServerInfo_ != null) {
        output.writeMessage(318, getStopServerInfo());
      }
      ...
      if (hACEPFEEKGA_ != 0) {
        output.writeUInt32(458, hACEPFEEKGA_);
      }
      if (platformType_ != 0) {
        output.writeUInt32(492, platformType_);
      }
      if (dPPKDPCKANP_ != 0) {
        output.writeUInt32(600, dPPKDPCKANP_);
      }
      ...
      for (int i = 0; i < featureBlockInfoList_.size(); i++) {
        output.writeMessage(1390, featureBlockInfoList_.get(i));
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(clientSilenceMd5_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 1435, clientSilenceMd5_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(clientSilenceVersionSuffix_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 1477, clientSilenceVersionSuffix_);
      }
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(clientMd5_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 1656, clientMd5_);
      }
      if (!scInfo_.isEmpty()) {
        output.writeBytes(1743, scInfo_);
      }
      if (isUseAbilityHash_ != false) {
        output.writeBool(1856, isUseAbilityHash_);
      }
      if (isScOpen_ != false) {
        output.writeBool(1869, isScOpen_);
      }
      if (resVersionConfig_ != null) {
      ...
      if (kLKDKMBAPGA_ != false) {
        output.writeBool(1994, kLKDKMBAPGA_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (jBEGCLMHOPF_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, jBEGCLMHOPF_);
      }
      if (gICKBBGJGCK_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(2, gICKBBGJGCK_);
      }
      if (!playerData_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (gHAJDNKLEDA_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(12, gHAJDNKLEDA_);
      }
      if (clientDataVersion_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (stopServerInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(318, getStopServerInfo());
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(countryCode_)) {
      ...
      if (hACEPFEEKGA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(458, hACEPFEEKGA_);
      }
      if (platformType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (dPPKDPCKANP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(600, dPPKDPCKANP_);
      }
      for (int i = 0; i < shortAbilityHashMap_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (oEMHPIKBDMB_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1056, oEMHPIKBDMB_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(msg_)) {
      ...
      if (hPHGKOCDPJE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1123, hPHGKOCDPJE_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(clientVersionSuffix_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1192, clientVersionSuffix_);
      }
      ...
      for (int i = 0; i < featureBlockInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1390, featureBlockInfoList_.get(i));
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(clientSilenceMd5_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1435, clientSilenceMd5_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(clientSilenceVersionSuffix_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1477, clientSilenceVersionSuffix_);
      }
      if (cGMBIAPFHGE_ != false) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(clientMd5_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1656, clientMd5_);
      }
      if (!scInfo_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isUseAbilityHash_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1856, isUseAbilityHash_);
      }
      if (isScOpen_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1869, isScOpen_);
      }
      if (resVersionConfig_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (kLKDKMBAPGA_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1994, kLKDKMBAPGA_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (hasStopServerInfo() != other.hasStopServerInfo()) return false;
      if (hasStopServerInfo()) {
        if (!getStopServerInfo()
            .equals(other.getStopServerInfo())) return false;
      }
      if (!getMsg()
      ...
      if (getDPPKDPCKANP()
          != other.getDPPKDPCKANP()) return false;
      ...
      if (getJBEGCLMHOPF()
          != other.getJBEGCLMHOPF()) return false;
      ...
      if (getHACEPFEEKGA()
          != other.getHACEPFEEKGA()) return false;
      if (getLoginRand()
    ...
    public int hashCode() {
      ...
      if (hasStopServerInfo()) {
        hash = (37 * hash) + STOP_SERVER_INFO_FIELD_NUMBER;
        hash = (53 * hash) + getStopServerInfo().hashCode();
      }
      ...
      hash = (37 * hash) + DPPKDPCKANP_FIELD_NUMBER;
      hash = (53 * hash) + getDPPKDPCKANP();
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getGICKBBGJGCK());
      hash = (37 * hash) + JBEGCLMHOPF_FIELD_NUMBER;
      hash = (53 * hash) + getJBEGCLMHOPF();
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getOEMHPIKBDMB());
      hash = (37 * hash) + HACEPFEEKGA_FIELD_NUMBER;
      hash = (53 * hash) + getHACEPFEEKGA();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        if (stopServerInfoBuilder_ == null) {
          stopServerInfo_ = null;
        } else {
          stopServerInfo_ = null;
          stopServerInfoBuilder_ = null;
        }
        msg_ = "";
      ...
      public emu.grasscutter.net.proto.PlayerLoginRspOuterClass.PlayerLoginRsp buildPartial() {
        ...
        if (stopServerInfoBuilder_ == null) {
          result.stopServerInfo_ = stopServerInfo_;
        } else {
          result.stopServerInfo_ = stopServerInfoBuilder_.build();
        }
        result.msg_ = msg_;
        ...
        result.dPPKDPCKANP_ = dPPKDPCKANP_;
        ...
        result.jBEGCLMHOPF_ = jBEGCLMHOPF_;
        ...
        result.hACEPFEEKGA_ = hACEPFEEKGA_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.PlayerLoginRspOuterClass.PlayerLoginRsp other) {
        ...
        if (other.hasStopServerInfo()) {
          mergeStopServerInfo(other.getStopServerInfo());
        }
        ...
        if (other.getDPPKDPCKANP() != 0) {
          setDPPKDPCKANP(other.getDPPKDPCKANP());
        }
        ...
        if (other.getJBEGCLMHOPF() != 0) {
          setJBEGCLMHOPF(other.getJBEGCLMHOPF());
        }
        ...
        if (other.getHACEPFEEKGA() != 0) {
          setHACEPFEEKGA(other.getHACEPFEEKGA());
        }
  ...
  checkByteStringIsUtf8(value);
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo, emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo.Builder, emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfoOrBuilder> stopServerInfoBuilder_;
      /**
       * <code>.StopServerInfo stop_server_info = 318;</code>
       * @return Whether the stopServerInfo field is set.
       */
      public boolean hasStopServerInfo() {
        return stopServerInfoBuilder_ != null || stopServerInfo_ != null;
      }
      /**
       * <code>.StopServerInfo stop_server_info = 318;</code>
       * @return The stopServerInfo.
      ...
      public emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo getStopServerInfo() {
        if (stopServerInfoBuilder_ == null) {
          ...
          return stopServerInfoBuilder_.getMessage();
        }
      }
      /**
       * <code>.StopServerInfo stop_server_info = 318;</code>
       */
      public Builder setStopServerInfo(emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo value) {
        if (stopServerInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          stopServerInfo_ = value;
          onChanged();
        } else {
          stopServerInfoBuilder_.setMessage(value);
        }
       ...
       * <code>.StopServerInfo stop_server_info = 318;</code>
       */
      public Builder setStopServerInfo(
          emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo.Builder builderForValue) {
        if (stopServerInfoBuilder_ == null) {
          stopServerInfo_ = builderForValue.build();
          onChanged();
        } else {
          stopServerInfoBuilder_.setMessage(builderForValue.build());
        }
       ...
       * <code>.StopServerInfo stop_server_info = 318;</code>
       */
      public Builder mergeStopServerInfo(emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo value) {
        if (stopServerInfoBuilder_ == null) {
          if (stopServerInfo_ != null) {
            stopServerInfo_ =
              emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo.newBuilder(stopServerInfo_).mergeFrom(value).buildPartial();
          } else {
            stopServerInfo_ = value;
          }
          onChanged();
        } else {
          stopServerInfoBuilder_.mergeFrom(value);
        }
       ...
       * <code>.StopServerInfo stop_server_info = 318;</code>
       */
      public Builder clearStopServerInfo() {
        if (stopServerInfoBuilder_ == null) {
          stopServerInfo_ = null;
          onChanged();
        } else {
       ...
       * <code>.StopServerInfo stop_server_info = 318;</code>
       */
      public emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo.Builder getStopServerInfoBuilder() {
        
        onChanged();
        return getStopServerInfoFieldBuilder().getBuilder();
      }
      /**
       * <code>.StopServerInfo stop_server_info = 318;</code>
       */
      public emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfoOrBuilder getStopServerInfoOrBuilder() {
        if (stopServerInfoBuilder_ != null) {
          return stopServerInfoBuilder_.getMessageOrBuilder();
        } else {
          return stopServerInfo_ == null ?
              emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo.getDefaultInstance() : stopServerInfo_;
        }
      }
      /**
       * <code>.StopServerInfo stop_server_info = 318;</code>
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          ...
          getStopServerInfoFieldBuilder() {
        if (stopServerInfoBuilder_ == null) {
          stopServerInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo, emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfo.Builder, emu.grasscutter.net.proto.StopServerInfoOuterClass.StopServerInfoOrBuilder>(
                  getStopServerInfo(),
  ...
  checkByteStringIsUtf8(value);
      ...
      /**
       * <code>uint32 DPPKDPCKANP = 600;</code>
       * @param value The dPPKDPCKANP to set.
       * @return This builder for chaining.
       */
      public Builder setDPPKDPCKANP(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearDPPKDPCKANP() {
      ...
      /**
       * <code>uint32 JBEGCLMHOPF = 1;</code>
       * @param value The jBEGCLMHOPF to set.
       * @return This builder for chaining.
       */
      public Builder setJBEGCLMHOPF(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearJBEGCLMHOPF() {
      ...
      /**
       * <code>uint32 HACEPFEEKGA = 458;</code>
       * @param value The hACEPFEEKGA to set.
       * @return This builder for chaining.
       */
      public Builder setHACEPFEEKGA(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearHACEPFEEKGA() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "shPair.proto\032\024StopServerInfo.proto\"\332\013\n\016P" +
      "layerLoginRsp\022\031\n\021next_resource_url\0307 \001(\t" +
      "\022*\n\020stop_server_info\030\276\002 \001(\0132\017.StopServer" +
      "Info\022\014\n\003msg\030\252\010 \001(\t\022\023\n\013player_data\030\003 \001(\014\022" +
      ".\n\022res_version_config\030\367\016 \001(\0132\021.ResVersio" +
      "nConfig\022\"\n\013LPFKKMMLFOP\030\360\002 \001(\0132\014.NGKOPBGL" +
      "DJM\022\021\n\010birthday\030\240\n \001(\t\022\033\n\022client_silence" +
      "_md5\030\233\013 \001(\t\0226\n\013KKNBKGBLHDM\030\215\014 \003(\0132 .Play" +
      "erLoginRsp.KKNBKGBLHDMEntry\022\023\n\nclient_md" +
      "5\030\370\014 \001(\t\0223\n\027next_res_version_config\030\300\017 \001" +
      "(\0132\021.ResVersionConfig\022\020\n\007sc_info\030\317\r \001(\014\022" +
      "6\n\026short_ability_hash_map\030\361\004 \003(\0132\025.Short" +
      "AbilityHashPair\022\020\n\010game_biz\030\013 \001(\t\022\036\n\025cli" +
      "ent_version_suffix\030\250\t \001(\t\022\025\n\014country_cod" +
      "e\030\326\002 \001(\t\022\025\n\014register_cps\030\226\006 \001(\t\022=\n\020abili" +
      "ty_hash_map\030\010 \003(\0132#.PlayerLoginRsp.Abili" +
      "tyHashMapEntry\022!\n\013KJEMCDAJINF\030\025 \001(\0132\014.FN" +
      "GEEAFJCDG\0223\n\027feature_block_info_list\030\356\n " +
      "\003(\0132\021.FeatureBlockInfo\022:\n\016block_info_map" +
      "\030\265\t \003(\0132!.PlayerLoginRsp.BlockInfoMapEnt" +
      "ry\022&\n\035client_silence_version_suffix\030\305\013 \001" +
      "(\t\022\030\n\017total_tick_time\030\363\005 \001(\001\022\022\n\ntarget_u" +
      "id\030\004 \001(\r\022\024\n\013DPPKDPCKANP\030\330\004 \001(\r\022\031\n\021abilit" +
      "y_hash_code\030\n \001(\005\022\033\n\023client_data_version" +
      "\030\r \001(\r\022\017\n\007retcode\030\t \001(\005\022\023\n\nis_sc_open\030\315\016" +
      " \001(\010\022\024\n\013CGMBIAPFHGE\030\344\013 \001(\010\022\034\n\023is_use_abi" +
      "lity_hash\030\300\016 \001(\010\022\023\n\013GICKBBGJGCK\030\002 \001(\010\022\023\n" +
      "\013JBEGCLMHOPF\030\001 \001(\r\022#\n\033client_silence_dat" +
      "a_version\030\017 \001(\r\022\024\n\013HPHGKOCDPJE\030\343\010 \001(\r\022\022\n" +
      "\nis_relogin\030\016 \001(\010\022\024\n\013KLKDKMBAPGA\030\312\017 \001(\010\022" +
      "\026\n\rplatform_type\030\354\003 \001(\r\022\021\n\010is_audit\030\261\n \001" +
      "(\010\022\023\n\013GHAJDNKLEDA\030\014 \001(\010\022\024\n\013MBPNFGLAJOG\030\215" +
      "\005 \001(\010\022\024\n\013OEMHPIKBDMB\030\240\010 \001(\010\022\024\n\013HACEPFEEK" +
      "GA\030\312\003 \001(\r\022\022\n\nlogin_rand\030\007 \001(\004\032@\n\020KKNBKGB" +
      "LHDMEntry\022\013\n\003key\030\001 \001(\004\022\033\n\005value\030\002 \001(\0132\014." +
      "MPGPEKAFHJG:\0028\001\0325\n\023AbilityHashMapEntry\022\013" +
    ...
    internal_static_PlayerLoginRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PlayerLoginRsp_descriptor,
        new java.lang.String[] { "NextResourceUrl", "StopServerInfo", "Msg", "PlayerData", "ResVersionConfig", "LPFKKMMLFOP", "Birthday", "ClientSilenceMd5", "KKNBKGBLHDM", "ClientMd5", "NextResVersionConfig", "ScInfo", "ShortAbilityHashMap", "GameBiz", "ClientVersionSuffix", "CountryCode", "RegisterCps", "AbilityHashMap", "KJEMCDAJINF", "FeatureBlockInfoList", "BlockInfoMap", "ClientSilenceVersionSuffix", "TotalTickTime", "TargetUid", "DPPKDPCKANP", "AbilityHashCode", "ClientDataVersion", "Retcode", "IsScOpen", "CGMBIAPFHGE", "IsUseAbilityHash", "GICKBBGJGCK", "JBEGCLMHOPF", "ClientSilenceDataVersion", "HPHGKOCDPJE", "IsRelogin", "KLKDKMBAPGA", "PlatformType", "IsAudit", "GHAJDNKLEDA", "MBPNFGLAJOG", "OEMHPIKBDMB", "HACEPFEEKGA", "LoginRand", });
    internal_static_PlayerLoginRsp_KKNBKGBLHDMEntry_descriptor =
