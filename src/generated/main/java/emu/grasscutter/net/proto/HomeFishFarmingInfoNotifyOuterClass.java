...
public final class HomeFishFarmingInfoNotifyOuterClass {
  ...
  public interface HomeFishFarmingInfoNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .HomeFishFarmingInfo fish_farming_info_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int FISH_FARMING_INFO_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < fishFarmingInfoList_.size(); i++) {
        output.writeMessage(3, fishFarmingInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < fishFarmingInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, fishFarmingInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nfoNotify\0224\n\026fish_farming_info_list\030\003 \003(" +
