...
public final class BlessingGetFriendPicListRspOuterClass {
  ...
  public interface BlessingGetFriendPicListRspOrBuilder extends
    ...
    /**
     * <code>repeated .BlessingFriendPicData friend_pic_data_list = 10;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int FRIEND_PIC_DATA_LIST_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < friendPicDataList_.size(); i++) {
        output.writeMessage(10, friendPicDataList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < friendPicDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, friendPicDataList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
