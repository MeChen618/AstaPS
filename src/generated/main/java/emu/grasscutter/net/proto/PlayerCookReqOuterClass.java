...
public final class PlayerCookReqOuterClass {
  ...
  public interface PlayerCookReqOrBuilder extends
    ...
    /**
     * <code>uint32 EBPHDCJFJEF = 10;</code>
     * @return The eBPHDCJFJEF.
     */
    int getEBPHDCJFJEF();
    ...
    /**
     * <code>uint32 MJAKDGHIIFB = 7;</code>
     * @return The mJAKDGHIIFB.
     */
    int getMJAKDGHIIFB();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              mJAKDGHIIFB_ = input.readUInt32();
              break;
            }
            case 80: {

              eBPHDCJFJEF_ = input.readUInt32();
              break;
            }
            case 112: {
    ...
    public static final int COOK_COUNT_FIELD_NUMBER = 4;
    ...
    public static final int EBPHDCJFJEF_FIELD_NUMBER = 10;
    private int eBPHDCJFJEF_;
    /**
     * <code>uint32 EBPHDCJFJEF = 10;</code>
     * @return The eBPHDCJFJEF.
     */
    @java.lang.Override
    public int getEBPHDCJFJEF() {
      return eBPHDCJFJEF_;
    }
    ...
    public static final int MJAKDGHIIFB_FIELD_NUMBER = 7;
    private int mJAKDGHIIFB_;
    /**
     * <code>uint32 MJAKDGHIIFB = 7;</code>
     * @return The mJAKDGHIIFB.
     */
    @java.lang.Override
    public int getMJAKDGHIIFB() {
      return mJAKDGHIIFB_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (cookCount_ != 0) {
        output.writeUInt32(4, cookCount_);
      }
      if (assistAvatar_ != 0) {
        output.writeUInt32(6, assistAvatar_);
      }
      if (mJAKDGHIIFB_ != 0) {
        output.writeUInt32(7, mJAKDGHIIFB_);
      }
      if (eBPHDCJFJEF_ != 0) {
        output.writeUInt32(10, eBPHDCJFJEF_);
      }
      if (recipeId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (cookCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, cookCount_);
      }
      if (assistAvatar_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (mJAKDGHIIFB_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, mJAKDGHIIFB_);
      }
      if (eBPHDCJFJEF_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, eBPHDCJFJEF_);
      }
      if (recipeId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getEBPHDCJFJEF()
          != other.getEBPHDCJFJEF()) return false;
      if (getAssistAvatar()
          != other.getAssistAvatar()) return false;
      if (getMJAKDGHIIFB()
          != other.getMJAKDGHIIFB()) return false;
      if (getRecipeId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + EBPHDCJFJEF_FIELD_NUMBER;
      hash = (53 * hash) + getEBPHDCJFJEF();
      hash = (37 * hash) + ASSIST_AVATAR_FIELD_NUMBER;
      hash = (53 * hash) + getAssistAvatar();
      hash = (37 * hash) + MJAKDGHIIFB_FIELD_NUMBER;
      hash = (53 * hash) + getMJAKDGHIIFB();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.PlayerCookReqOuterClass.PlayerCookReq buildPartial() {
        ...
        result.eBPHDCJFJEF_ = eBPHDCJFJEF_;
        result.assistAvatar_ = assistAvatar_;
        result.mJAKDGHIIFB_ = mJAKDGHIIFB_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.PlayerCookReqOuterClass.PlayerCookReq other) {
        ...
        if (other.getEBPHDCJFJEF() != 0) {
          setEBPHDCJFJEF(other.getEBPHDCJFJEF());
        }
        if (other.getAssistAvatar() != 0) {
          setAssistAvatar(other.getAssistAvatar());
        }
        if (other.getMJAKDGHIIFB() != 0) {
          setMJAKDGHIIFB(other.getMJAKDGHIIFB());
        }
      ...
      /**
       * <code>uint32 EBPHDCJFJEF = 10;</code>
       * @param value The eBPHDCJFJEF to set.
       * @return This builder for chaining.
       */
      public Builder setEBPHDCJFJEF(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearEBPHDCJFJEF() {
      ...
      /**
       * <code>uint32 MJAKDGHIIFB = 7;</code>
       * @param value The mJAKDGHIIFB to set.
       * @return This builder for chaining.
       */
      public Builder setMJAKDGHIIFB(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearMJAKDGHIIFB() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\023PlayerCookReq.proto\"\214\001\n\rPlayerCookReq\022" +
      "\022\n\ncook_count\030\004 \001(\r\022\023\n\013qte_quality\030\001 \001(\r" +
      "\022\023\n\013EBPHDCJFJEF\030\n \001(\r\022\025\n\rassist_avatar\030\006" +
      " \001(\r\022\023\n\013MJAKDGHIIFB\030\007 \001(\r\022\021\n\trecipe_id\030\016" +
    ...
    internal_static_PlayerCookReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PlayerCookReq_descriptor,
        new java.lang.String[] { "CookCount", "QteQuality", "EBPHDCJFJEF", "AssistAvatar", "MJAKDGHIIFB", "RecipeId", });
  }
