...
public final class OpActivityDataNotifyOuterClass {
  ...
  public interface OpActivityDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .OpActivityInfo op_activity_info_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int OP_ACTIVITY_INFO_LIST_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < opActivityInfoList_.size(); i++) {
        output.writeMessage(1, opActivityInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < opActivityInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, opActivityInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_activity_info_list\030\001 \003(\0132\017.OpActivityIn" +
