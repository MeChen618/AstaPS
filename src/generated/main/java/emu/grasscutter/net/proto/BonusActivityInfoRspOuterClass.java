...
public final class BonusActivityInfoRspOuterClass {
  ...
  public interface BonusActivityInfoRspOrBuilder extends
    ...
    /**
     * <code>repeated .BonusActivityInfo bonus_activity_info_list = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BONUS_ACTIVITY_INFO_LIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < bonusActivityInfoList_.size(); i++) {
        output.writeMessage(6, bonusActivityInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < bonusActivityInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, bonusActivityInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030bonus_activity_info_list\030\006 \003(\0132\022.BonusA" +
