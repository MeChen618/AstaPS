...
public final class DeathZoneInfoNotifyOuterClass {
  ...
  public interface DeathZoneInfoNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .DeathZoneInfo death_zone_info_list = 7;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DEATH_ZONE_INFO_LIST_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < deathZoneInfoList_.size(); i++) {
        output.writeMessage(7, deathZoneInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < deathZoneInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, deathZoneInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_zone_info_list\030\007 \003(\0132\016.DeathZoneInfoB\033\n" +
