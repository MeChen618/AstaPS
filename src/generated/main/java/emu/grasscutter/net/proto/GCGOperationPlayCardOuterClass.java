...
public final class GCGOperationPlayCardOuterClass {
  ...
  public interface GCGOperationPlayCardOrBuilder extends
    ...
    /**
     * <code>uint32 replace_card_guid = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int REPLACE_CARD_GUID_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (replaceCardGuid_ != 0) {
        output.writeUInt32(1, replaceCardGuid_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (replaceCardGuid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, replaceCardGuid_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < costDiceIndexList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ationPlayCard\022\035\n\025target_card_guid_list\030\t" +
      " \003(\r\022\034\n\024cost_dice_index_list\030\003 \003(\r\022\021\n\tca" +
      "rd_guid\030\006 \001(\r\022\031\n\021replace_card_guid\030\001 \001(\r" +
