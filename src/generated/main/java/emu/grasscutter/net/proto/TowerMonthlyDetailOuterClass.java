...
public final class TowerMonthlyDetailOuterClass {
  ...
  public interface TowerMonthlyDetailOrBuilder extends
    ...
    /**
     * <code>.TowerMonthlyCombatRecord monthly_combat_record = 7;</code>
    ...
    /**
     * <code>uint32 FPFNLDNMACP = 15;</code>
     * @return The fPFNLDNMACP.
     */
    int getFPFNLDNMACP();

    /**
     * <code>bool GLBJCKAANLK = 9;</code>
     * @return The gLBJCKAANLK.
     */
    boolean getGLBJCKAANLK();

    /**
     * <code>bool BNGBAHKIENI = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MONTHLY_COMBAT_RECORD_FIELD_NUMBER = 7;
    ...
    public static final int FPFNLDNMACP_FIELD_NUMBER = 15;
    ...
    public static final int GLBJCKAANLK_FIELD_NUMBER = 9;
    ...
    public static final int BNGBAHKIENI_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (bNGBAHKIENI_ != false) {
        output.writeBool(3, bNGBAHKIENI_);
      }
      if (monthlyCombatRecord_ != null) {
        output.writeMessage(7, getMonthlyCombatRecord());
      }
      if (gLBJCKAANLK_ != false) {
        output.writeBool(9, gLBJCKAANLK_);
      }
      if (monthlyBrief_ != null) {
        output.writeMessage(13, getMonthlyBrief());
      }
      if (fPFNLDNMACP_ != 0) {
        output.writeUInt32(15, fPFNLDNMACP_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (bNGBAHKIENI_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(3, bNGBAHKIENI_);
      }
      if (monthlyCombatRecord_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, getMonthlyCombatRecord());
      }
      if (gLBJCKAANLK_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(9, gLBJCKAANLK_);
      }
      if (monthlyBrief_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (fPFNLDNMACP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, fPFNLDNMACP_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "mbat_record\030\007 \001(\0132\031.TowerMonthlyCombatRe" +
      "cord\022)\n\rmonthly_brief\030\r \001(\0132\022.TowerMonth" +
      "lyBrief\022\023\n\013FPFNLDNMACP\030\017 \001(\r\022\023\n\013GLBJCKAA" +
      "NLK\030\t \001(\010\022\023\n\013BNGBAHKIENI\030\003 \001(\010B\033\n\031emu.gr" +
    ...
    internal_static_TowerMonthlyDetail_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TowerMonthlyDetail_descriptor,
        new java.lang.String[] { "MonthlyCombatRecord", "MonthlyBrief", "FPFNLDNMACP", "GLBJCKAANLK", "BNGBAHKIENI", });
    emu.grasscutter.net.proto.TowerMonthlyBriefOuterClass.getDescriptor();
    emu.grasscutter.net.proto.TowerMonthlyCombatRecordOuterClass.getDescriptor();
  }
