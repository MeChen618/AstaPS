...
public final class AbilityMixinBreakoutOuterClass {
  ...
  public interface AbilityMixinBreakoutOrBuilder extends
    ...
    /**
     * <code>.AbilityMixinBreakout.SyncType sync_type = 12;</code>
    ...
    /**
     * <code>.BreakoutSyncPing sync_ping = 13;</code>
    ...
    /**
     * <code>.BreakoutSyncFinishGame sync_finish_game = 8;</code>
    ...
    /**
     * <code>.BreakoutSyncSnapShot sync_snap_shot = 1;</code>
    ...
    /**
     * <code>.BreakoutSyncAction sync_action = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum SyncCase
      ...
      public static SyncCase forNumber(int value) {
        switch (value) {
          ...
          case 13: return SYNC_PING;
          case 8: return SYNC_FINISH_GAME;
          case 1: return SYNC_SNAP_SHOT;
    ...
    public static final int SYNC_PING_FIELD_NUMBER = 13;
    /**
     * <code>.BreakoutSyncPing sync_ping = 13;</code>
     * @return Whether the syncPing field is set.
     */
    ...
    public static final int SYNC_SNAP_SHOT_FIELD_NUMBER = 1;
    /**
     * <code>.BreakoutSyncSnapShot sync_snap_shot = 1;</code>
     * @return Whether the syncSnapShot field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (syncCase_ == 1) {
        output.writeMessage(1, (emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot) sync_);
      }
      if (syncCase_ == 4) {
        output.writeMessage(4, (emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction) sync_);
      }
      if (retcode_ != 0) {
        output.writeInt32(7, retcode_);
      }
      if (syncCase_ == 8) {
        output.writeMessage(8, (emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame) sync_);
      }
      ...
      if (syncCase_ == 13) {
        output.writeMessage(13, (emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing) sync_);
      }
      if (syncCase_ == 15) {
    ...
    public int getSerializedSize() {
      ...
      if (syncCase_ == 1) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, (emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot) sync_);
      }
      if (syncCase_ == 4) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, (emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction) sync_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (syncCase_ == 8) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, (emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame) sync_);
      }
      if (syncType_ != emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncType.SyncType_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (syncCase_ == 13) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, (emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing) sync_);
      }
      if (syncCase_ == 15) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPingOrBuilder getSyncPingOrBuilder() {
        if ((syncCase_ == 13) && (syncPingBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShotOrBuilder getSyncSnapShotOrBuilder() {
        if ((syncCase_ == 1) && (syncSnapShotBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncActionOrBuilder getSyncActionOrBuilder() {
        if ((syncCase_ == 4) && (syncActionBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nc_type\030\014 \001(\0162\036.AbilityMixinBreakout.Syn" +
      "cType\022\017\n\007retcode\030\007 \001(\005\0229\n\023sync_create_co" +
      "nnect\030\017 \001(\0132\032.BreakoutSyncCreateConnectH" +
      "\000\022&\n\tsync_ping\030\r \001(\0132\021.BreakoutSyncPingH" +
      "\000\0223\n\020sync_finish_game\030\010 \001(\0132\027.BreakoutSy" +
      "ncFinishGameH\000\022/\n\016sync_snap_shot\030\001 \001(\0132\025" +
      ".BreakoutSyncSnapShotH\000\022*\n\013sync_action\030\004" +
      " \001(\0132\023.BreakoutSyncActionH\000\"\255\001\n\010SyncType" +
