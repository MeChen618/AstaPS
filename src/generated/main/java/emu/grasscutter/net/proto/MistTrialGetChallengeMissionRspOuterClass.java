...
public final class MistTrialGetChallengeMissionRspOuterClass {
  ...
  public interface MistTrialGetChallengeMissionRspOrBuilder extends
    ...
    /**
     * <code>repeated .MistTrialMissionInfo mission_info_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MISSION_INFO_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < missionInfoList_.size(); i++) {
        output.writeMessage(4, missionInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < missionInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, missionInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ist\030\004 \003(\0132\025.MistTrialMissionInfo\022\017\n\007retc" +
      "ode\030\001 \001(\005\022\020\n\010trial_id\030\002 \001(\rB\033\n\031emu.grass" +
