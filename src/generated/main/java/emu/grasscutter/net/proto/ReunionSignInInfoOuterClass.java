...
public final class ReunionSignInInfoOuterClass {
  ...
  public interface ReunionSignInInfoOrBuilder extends
    ...
    /**
     * <code>uint32 last_sign_in_time = 8;</code>
    ...
    /**
     * <code>uint32 sign_in_count = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LAST_SIGN_IN_TIME_FIELD_NUMBER = 8;
    ...
    public static final int SIGN_IN_COUNT_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (signInCount_ != 0) {
        output.writeUInt32(4, signInCount_);
      }
      if (configId_ != 0) {
        output.writeUInt32(7, configId_);
      }
      if (lastSignInTime_ != 0) {
        output.writeUInt32(8, lastSignInTime_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (signInCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, signInCount_);
      }
      if (configId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (lastSignInTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, lastSignInTime_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < rewardDayList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "InInfo\022\027\n\017reward_day_list\030\014 \003(\r\022\031\n\021last_" +
      "sign_in_time\030\010 \001(\r\022\021\n\tconfig_id\030\007 \001(\r\022\025\n" +
      "\rsign_in_count\030\004 \001(\rB\033\n\031emu.grasscutter." +
    ...
    internal_static_ReunionSignInInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ReunionSignInInfo_descriptor,
        new java.lang.String[] { "RewardDayList", "LastSignInTime", "ConfigId", "SignInCount", });
  }
