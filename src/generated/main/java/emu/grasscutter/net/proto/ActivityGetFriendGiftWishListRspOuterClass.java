...
public final class ActivityGetFriendGiftWishListRspOuterClass {
  ...
  public interface ActivityGetFriendGiftWishListRspOrBuilder extends
    ...
    /**
     * <code>repeated .ActivityFriendGiftWishData friend_gift_wish_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int FRIEND_GIFT_WISH_LIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < friendGiftWishList_.size(); i++) {
        output.writeMessage(2, friendGiftWishList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < friendGiftWishList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, friendGiftWishList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "d_gift_wish_list\030\002 \003(\0132\033.ActivityFriendG" +
