...
public final class EvtCombatForceSetPosInfoOuterClass {
  ...
  public interface EvtCombatForceSetPosInfoOrBuilder extends
    ...
    /**
     * <code>uint32 collider_entity_id = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int COLLIDER_ENTITY_ID_FIELD_NUMBER = 3;
    ...
    public static final int ICE_ID_FIELD_NUMBER = 10;
    private int iceId_;
    /**
     * <code>uint32 ice_id = 10;</code>
     * @return The iceId.
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (colliderEntityId_ != 0) {
        output.writeUInt32(3, colliderEntityId_);
      }
      if (entityId_ != 0) {
        output.writeUInt32(7, entityId_);
      }
      if (iceId_ != 0) {
        output.writeUInt32(10, iceId_);
      }
      if (targetPos_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (colliderEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, colliderEntityId_);
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rget_pos\030\016 \001(\0132\007.Vector\022\032\n\022collider_enti" +
    ...
    internal_static_EvtCombatForceSetPosInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_EvtCombatForceSetPosInfo_descriptor,
        new java.lang.String[] { "TargetPos", "ColliderEntityId", "EntityId", "IceId", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
