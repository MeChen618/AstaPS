...
public final class ExpeditionChallengeEnterRegionNotifyOuterClass {
  ...
  public interface ExpeditionChallengeEnterRegionNotifyOrBuilder extends
    ...
    /**
     * <code>bool is_puzzle_finished = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_PUZZLE_FINISHED_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isPuzzleFinished_ != false) {
        output.writeBool(3, isPuzzleFinished_);
      }
      if (id_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (isPuzzleFinished_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(3, isPuzzleFinished_);
      }
      if (id_ != 0) {
        size += com.google.protobuf.CodedOutputStream
