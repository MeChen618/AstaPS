...
public final class CodexDataFullNotifyOuterClass {
  ...
  public interface CodexDataFullNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 last_read_pushtips_codex_id = 10;</code>
     * @return The lastReadPushtipsCodexId.
     */
    int getLastReadPushtipsCodexId();

    /**
     * <code>uint32 last_read_pushtips_type_id = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LAST_READ_PUSHTIPS_CODEX_ID_FIELD_NUMBER = 10;
    ...
    public static final int LAST_READ_PUSHTIPS_TYPE_ID_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lastReadPushtipsTypeId_ != 0) {
        output.writeUInt32(4, lastReadPushtipsTypeId_);
      }
      ...
      if (lastReadPushtipsCodexId_ != 0) {
        output.writeUInt32(10, lastReadPushtipsCodexId_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (lastReadPushtipsTypeId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, lastReadPushtipsTypeId_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < recentViewedPushtipsList_.size(); i++) {
      ...
      if (lastReadPushtipsCodexId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, lastReadPushtipsCodexId_);
      }
      for (int i = 0; i < typeDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_data_list\030\017 \003(\0132\016.CodexTypeData\022#\n\033rece" +
      "nt_viewed_pushtips_list\030\006 \003(\r\022#\n\033last_re" +
      "ad_pushtips_codex_id\030\n \001(\r\022\"\n\032last_read_" +
      "pushtips_type_id\030\004 \001(\rB\033\n\031emu.grasscutte" +
    ...
    internal_static_CodexDataFullNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_CodexDataFullNotify_descriptor,
        new java.lang.String[] { "TypeDataList", "RecentViewedPushtipsList", "LastReadPushtipsCodexId", "LastReadPushtipsTypeId", });
    emu.grasscutter.net.proto.CodexTypeDataOuterClass.getDescriptor();
  }
