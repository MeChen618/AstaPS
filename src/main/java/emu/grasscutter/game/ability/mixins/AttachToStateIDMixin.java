...
@AbilityMixin(value=AbilityMixinData.Type.AttachToStateIDMixin)
public class AttachToStateIDMixin
    ...
    public boolean execute(Ability ability, AbilityMixinData abilityMixinData, ByteString byteString, GameEntity gameEntity) {
        ...
        for (String string : list) {
            ...
            if (abilityModifier == null) {
                Grasscutter.getLogger().debug("AttachToStateIDMixin missing modifier {}", (Object)string);
                continue;
            }
            try {
                ...
                Grasscutter.getLogger().warn("AttachToStateIDMixin apply {} failed", (Object)string, (Object)throwable);
            }
        }
        return true;
    }
