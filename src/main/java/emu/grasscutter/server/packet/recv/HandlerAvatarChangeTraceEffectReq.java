...
import emu.grasscutter.net.proto.AvatarChangeTraceEffectReq;
import emu.grasscutter.server.game.GameSession;
import emu.grasscutter.server.packet.send.PacketAvatarChangeTraceEffectRsp;

@Opcodes(PacketOpcodes._AvatarChangeTraceEffectReq)
public class HandlerAvatarChangeTraceEffectReq
extends PacketHandler {
    @Override
    public void handle(GameSession session, byte[] header, byte[] payload) throws Exception {
        AvatarChangeTraceEffectReq._AvatarChangeTraceEffectReq req = AvatarChangeTraceEffectReq._AvatarChangeTraceEffectReq.parseFrom(payload);
